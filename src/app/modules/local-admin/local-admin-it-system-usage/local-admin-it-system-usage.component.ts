...
@Component({
    ...
    imports: [SegmentComponent, NgIf, LocalAdminItSystemUsageUiCustomizationComponent, LocalAdminItSystemUsageOptionTypesComponent, LocalAdminItSystemUsageRoleOptionTypesComponent]
})
