...
import { DeleteOrganizationDialogComponent } from './global-admin-organizations/organizations-dialogs/delete-organization-dialog/delete-organization-dialog.component';
import { InnerConflictTableComponent } from './global-admin-organizations/organizations-dialogs/delete-organization-dialog/removal-conflict-table/inner-conflict-table/inner-conflict-table.component';
import { RemovalConflictTableComponent } from './global-admin-organizations/organizations-dialogs/delete-organization-dialog/removal-conflict-table/removal-conflict-table.component';
import { EditOrganizationDialogComponent } from './global-admin-organizations/organizations-dialogs/edit-organization-dialog/edit-organization-dialog.component';
...
@NgModule({
    imports: [CommonModule, ComponentsModule, SharedModule, GlobalAdminRouterModule, GlobalAdminComponent,
