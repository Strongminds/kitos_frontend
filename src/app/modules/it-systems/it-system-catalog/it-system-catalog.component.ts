...
export class ItSystemCatalogComponent extends BaseOverviewComponent implements OnInit {
  ...
  public readonly defaultGridColumns: GridColumn[] = [
    ...
    {
      field: CatalogFields.ACTIVE_USAGES,
      dataField: 'Name',
      idField: CatalogFields.UUID,
      title: $localize`IT System: Anvendes af (aktiv)`,
      section: this.systemSectionName,
      style: 'usages',
      entityType: 'it-system',
      hidden: false,
    ...
    {
      field: CatalogFields.INACTIVE_USAGES,
      dataField: 'Name',
      idField: CatalogFields.UUID,
      title: $localize`IT System: Anvendes af (inaktiv)`,
      section: this.systemSectionName,
      style: 'usages',
      entityType: 'it-system',
      hidden: false,
