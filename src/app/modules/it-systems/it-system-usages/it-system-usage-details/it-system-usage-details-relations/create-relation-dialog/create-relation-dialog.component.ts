...
export class CreateRelationDialogComponent extends BaseComponent {
  public relationForm = new FormGroup<SystemRelationCreateDialogFormModel>({
    ...
    public save() {
      ...
      const requests = formValue.interfaces === undefined || formValue.interfaces === null || formValue.interfaces.length === 0
        ? [
          {
...
//TODO implement action for multi-create
//      this.store.dispatch(ITSystemUsageActions.addItSystemUsageRelation(requests));
    }
