...
export namespace APIContractTerminationTermsRequestDTO {
  ...
  export const NoticePeriodExtendsCurrentEnum = {
    ...
    EndOfQuarter: 'EndOfQuarter' as NoticePeriodExtendsCurrentEnum,
    EndOfMonth: 'EndOfMonth' as NoticePeriodExtendsCurrentEnum,
  };
  export type NoticeByEndOfEnum = 'EndOfCalendarYear' | 'EndOfQuarter' | 'EndOfMonth';
  export const NoticeByEndOfEnum = {
    EndOfCalendarYear: 'EndOfCalendarYear' as NoticeByEndOfEnum,
    EndOfQuarter: 'EndOfQuarter' as NoticeByEndOfEnum,
    EndOfMonth: 'EndOfMonth' as NoticeByEndOfEnum,
  };
}
