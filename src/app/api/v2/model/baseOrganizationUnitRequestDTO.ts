...
export interface APIBaseOrganizationUnitRequestDTO { 
    name?: string | null;
    origin?: APIBaseOrganizationUnitRequestDTO.OriginEnum;
    parentUuid?: string;
    ean?: number | null;
    localId?: string | null;
}
export namespace APIBaseOrganizationUnitRequestDTO {
