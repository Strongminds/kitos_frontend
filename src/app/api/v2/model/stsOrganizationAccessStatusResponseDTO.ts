...
export interface APIStsOrganizationAccessStatusResponseDTO {
  ...
  /**
   * If {Presentation.Web.Models.API.V2.Internal.Response.Organizations.StsOrganizationAccessStatusResponseDTO.AccessGranted} is false, this field contains the access error
   */
