...
export interface PatchSingleItContractInternalV2PatchAddBulkRoleAssignmentRequestParams {
    contractUuid: string;
...
export class APIV2ItContractInternalINTERNALService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public patchSingleItContractInternalV2PatchAddBulkRoleAssignment(requestParameters: PatchSingleItContractInternalV2PatchAddBulkRoleAssignmentRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<APIItContractResponseDTO>;
    public patchSingleItContractInternalV2PatchAddBulkRoleAssignment(requestParameters: PatchSingleItContractInternalV2PatchAddBulkRoleAssignmentRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<APIItContractResponseDTO>>;
    public patchSingleItContractInternalV2PatchAddBulkRoleAssignment(requestParameters: PatchSingleItContractInternalV2PatchAddBulkRoleAssignmentRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<APIItContractResponseDTO>>;
    public patchSingleItContractInternalV2PatchAddBulkRoleAssignment(requestParameters: PatchSingleItContractInternalV2PatchAddBulkRoleAssignmentRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const contractUuid = requestParameters.contractUuid;
        if (contractUuid === null || contractUuid === undefined) {
            throw new Error('Required parameter contractUuid was null or undefined when calling patchSingleItContractInternalV2PatchAddBulkRoleAssignment.');
        }
        const request = requestParameters.request;
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling patchSingleItContractInternalV2PatchAddBulkRoleAssignment.');
        }
        ...
        let localVarPath = `/api/v2/internal/it-contracts/${this.configuration.encodeParam({name: "contractUuid", value: contractUuid, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}/roles/bulk/add`;
