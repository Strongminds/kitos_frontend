...
export interface PostSingleItSystemGlobalItSystemCategoriesInternalV2CreateGlobalItSystemCategoriesRequestParams {
...
export class APIV2ItSystemGlobalItSystemCategoriesInternalINTERNALService {
   ...
   */
  public getManyItSystemGlobalItSystemCategoriesInternalV2GetGlobalItSystemCategoriess(
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public patchSingleItSystemGlobalItSystemCategoriesInternalV2PatchGlobalItSystemCategories(
    requestParameters: PatchSingleItSystemGlobalItSystemCategoriesInternalV2PatchGlobalItSystemCategoriesRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public patchSingleItSystemGlobalItSystemCategoriesInternalV2PatchGlobalItSystemCategories(
    ...
    if (optionUuid === null || optionUuid === undefined) {
      throw new Error(
        'Required parameter optionUuid was null or undefined when calling patchSingleItSystemGlobalItSystemCategoriesInternalV2PatchGlobalItSystemCategories.',
      );
    }
    const dto = requestParameters.dto;
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling patchSingleItSystemGlobalItSystemCategoriesInternalV2PatchGlobalItSystemCategories.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleItSystemGlobalItSystemCategoriesInternalV2CreateGlobalItSystemCategories(
    requestParameters: PostSingleItSystemGlobalItSystemCategoriesInternalV2CreateGlobalItSystemCategoriesRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIGlobalRegularOptionResponseDTO>;
  ...
  public postSingleItSystemGlobalItSystemCategoriesInternalV2CreateGlobalItSystemCategories(
    ...
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling postSingleItSystemGlobalItSystemCategoriesInternalV2CreateGlobalItSystemCategories.',
      );
    }
