...
export class APIV2ItSystemUsageRoleTypeService {
   ...
   */
  public getManyItSystemUsageRoleTypeV2Get(
    requestParameters: GetManyItSystemUsageRoleTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItSystemUsageRoleTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageRoleTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageRoleTypeV2GetV1(
    requestParameters: GetSingleItSystemUsageRoleTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItSystemUsageRoleTypeV2GetV1(
    ...
    if (systemUsageRoleTypeUuid === null || systemUsageRoleTypeUuid === undefined) {
      throw new Error(
        'Required parameter systemUsageRoleTypeUuid was null or undefined when calling getSingleItSystemUsageRoleTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItSystemUsageRoleTypeV2GetV1.',
      );
    }
