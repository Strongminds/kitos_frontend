...
export class ItContractGlobalPriceRegulationTypesInternalV2Service {
     ...
     */
    public getSingleItContractGlobalPriceRegulationTypesInternalV2GetGlobalPriceRegulationTypes(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any>;
    public getSingleItContractGlobalPriceRegulationTypesInternalV2GetGlobalPriceRegulationTypes(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<any>>;
    public getSingleItContractGlobalPriceRegulationTypesInternalV2GetGlobalPriceRegulationTypes(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<any>>;
    public getSingleItContractGlobalPriceRegulationTypesInternalV2GetGlobalPriceRegulationTypes(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
