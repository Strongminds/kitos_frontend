...
export class APIV2ItSystemUsageSensitivePersonalDataTypeService {
   ...
   */
  public getManyItSystemUsageSensitivePersonalDataTypeV2Get(
    requestParameters: GetManyItSystemUsageSensitivePersonalDataTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItSystemUsageSensitivePersonalDataTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageSensitivePersonalDataTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageSensitivePersonalDataTypeV2GetV1(
    requestParameters: GetSingleItSystemUsageSensitivePersonalDataTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItSystemUsageSensitivePersonalDataTypeV2GetV1(
    ...
    if (sensitivePersonalDataTypeUuid === null || sensitivePersonalDataTypeUuid === undefined) {
      throw new Error(
        'Required parameter sensitivePersonalDataTypeUuid was null or undefined when calling getSingleItSystemUsageSensitivePersonalDataTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItSystemUsageSensitivePersonalDataTypeV2GetV1.',
      );
    }
