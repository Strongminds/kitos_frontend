...
export class APIV2DeltaFeedService {
   ...
   */
  public getManyDeltaFeedV2GetDeletedObjects(
    requestParameters: GetManyDeltaFeedV2GetDeletedObjectsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APITrackingEventResponseDTO>>;
  public getManyDeltaFeedV2GetDeletedObjects(
    requestParameters: GetManyDeltaFeedV2GetDeletedObjectsRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APITrackingEventResponseDTO>>>;
  public getManyDeltaFeedV2GetDeletedObjects(
    requestParameters: GetManyDeltaFeedV2GetDeletedObjectsRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APITrackingEventResponseDTO>>>;
  public getManyDeltaFeedV2GetDeletedObjects(
    requestParameters: GetManyDeltaFeedV2GetDeletedObjectsRequestParams,
    observe: any = 'body',
    ...
    if (deletedSinceUTC !== undefined && deletedSinceUTC !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>deletedSinceUTC, 'deletedSinceUTC');
    }
    ...
    return this.httpClient.request<Array<APITrackingEventResponseDTO>>(
      'get',
