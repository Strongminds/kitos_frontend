...
export class APIV2ItContractPurchaseTypeService {
   ...
   */
  public getManyItContractPurchaseTypeV2Get(
    requestParameters: GetManyItContractPurchaseTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItContractPurchaseTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItContractPurchaseTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractPurchaseTypeV2GetV1(
    requestParameters: GetSingleItContractPurchaseTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItContractPurchaseTypeV2GetV1(
    ...
    if (purchaseTypeUuid === null || purchaseTypeUuid === undefined) {
      throw new Error(
        'Required parameter purchaseTypeUuid was null or undefined when calling getSingleItContractPurchaseTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItContractPurchaseTypeV2GetV1.',
      );
    }
