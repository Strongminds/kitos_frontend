...
export class APIV2ItSystemUsageArchiveLocationTypeService {
   ...
   */
  public getManyItSystemUsageArchiveLocationTypeV2Get(
    requestParameters: GetManyItSystemUsageArchiveLocationTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItSystemUsageArchiveLocationTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageArchiveLocationTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageArchiveLocationTypeV2GetV1(
    requestParameters: GetSingleItSystemUsageArchiveLocationTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItSystemUsageArchiveLocationTypeV2GetV1(
    ...
    if (archiveLocationUuid === null || archiveLocationUuid === undefined) {
      throw new Error(
        'Required parameter archiveLocationUuid was null or undefined when calling getSingleItSystemUsageArchiveLocationTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItSystemUsageArchiveLocationTypeV2GetV1.',
      );
    }
