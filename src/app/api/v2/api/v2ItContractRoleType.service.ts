...
export class APIV2ItContractRoleTypeService {
   ...
   */
  public getManyItContractRoleTypeV2Get(
    requestParameters: GetManyItContractRoleTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItContractRoleTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItContractRoleTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractRoleTypeV2GetV1(
    requestParameters: GetSingleItContractRoleTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItContractRoleTypeV2GetV1(
    ...
    if (contractRoleTypeUuid === null || contractRoleTypeUuid === undefined) {
      throw new Error(
        'Required parameter contractRoleTypeUuid was null or undefined when calling getSingleItContractRoleTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItContractRoleTypeV2GetV1.',
      );
    }
