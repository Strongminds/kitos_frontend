...
export class APIV2ItSystemUsageRelationFrequencyTypeService {
   ...
   */
  public getManyItSystemUsageRelationFrequencyTypeV2Get(
    requestParameters: GetManyItSystemUsageRelationFrequencyTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItSystemUsageRelationFrequencyTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageRelationFrequencyTypeV2Get.',
      );
    }
  ...
  public getSingleItSystemUsageRelationFrequencyTypeV2GetV1(
    requestParameters: GetSingleItSystemUsageRelationFrequencyTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItSystemUsageRelationFrequencyTypeV2GetV1(
    ...
    if (relationFrequencyTypeUuid === null || relationFrequencyTypeUuid === undefined) {
      throw new Error(
        'Required parameter relationFrequencyTypeUuid was null or undefined when calling getSingleItSystemUsageRelationFrequencyTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItSystemUsageRelationFrequencyTypeV2GetV1.',
      );
    }
