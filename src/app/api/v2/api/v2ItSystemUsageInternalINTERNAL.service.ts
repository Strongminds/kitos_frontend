...
export class APIV2ItSystemUsageInternalINTERNALService {
  ...
  public deleteSingleItSystemUsageInternalV2DeleteItSystemUsageByOrganizationUuidAndSystemUuid(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling deleteSingleItSystemUsageInternalV2DeleteItSystemUsageByOrganizationUuidAndSystemUuid.',
      );
    }
    const systemUuid = requestParameters.systemUuid;
    if (systemUuid === null || systemUuid === undefined) {
      throw new Error(
        'Required parameter systemUuid was null or undefined when calling deleteSingleItSystemUsageInternalV2DeleteItSystemUsageByOrganizationUuidAndSystemUuid.',
      );
    }
  ...
  public getManyItSystemUsageInternalV2GetAddRoleAssignments(
    ...
    if (systemUsageUuid === null || systemUsageUuid === undefined) {
      throw new Error(
        'Required parameter systemUsageUuid was null or undefined when calling getManyItSystemUsageInternalV2GetAddRoleAssignments.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getManyItSystemUsageInternalV2GetItSystemUsages(
    requestParameters: GetManyItSystemUsageInternalV2GetItSystemUsagesRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIItSystemUsageSearchResultResponseDTO>>;
  public getManyItSystemUsageInternalV2GetItSystemUsages(
    requestParameters: GetManyItSystemUsageInternalV2GetItSystemUsagesRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIItSystemUsageSearchResultResponseDTO>>>;
  public getManyItSystemUsageInternalV2GetItSystemUsages(
    requestParameters: GetManyItSystemUsageInternalV2GetItSystemUsagesRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIItSystemUsageSearchResultResponseDTO>>>;
  public getManyItSystemUsageInternalV2GetItSystemUsages(
    requestParameters: GetManyItSystemUsageInternalV2GetItSystemUsagesRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageInternalV2GetItSystemUsages.',
      );
    }
    ...
    return this.httpClient.request<Array<APIItSystemUsageSearchResultResponseDTO>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getManyItSystemUsageInternalV2GetRelations(
    requestParameters: GetManyItSystemUsageInternalV2GetRelationsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIGeneralSystemRelationResponseDTO>>;
  public getManyItSystemUsageInternalV2GetRelations(
    requestParameters: GetManyItSystemUsageInternalV2GetRelationsRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIGeneralSystemRelationResponseDTO>>>;
  public getManyItSystemUsageInternalV2GetRelations(
    requestParameters: GetManyItSystemUsageInternalV2GetRelationsRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIGeneralSystemRelationResponseDTO>>>;
  public getManyItSystemUsageInternalV2GetRelations(
    requestParameters: GetManyItSystemUsageInternalV2GetRelationsRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (contractUuid === null || contractUuid === undefined) {
      throw new Error(
        'Required parameter contractUuid was null or undefined when calling getManyItSystemUsageInternalV2GetRelations.',
      );
    }
    ...
    return this.httpClient.request<Array<APIGeneralSystemRelationResponseDTO>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
