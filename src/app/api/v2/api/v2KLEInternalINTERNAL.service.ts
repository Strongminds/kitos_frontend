...
// @ts-ignore
import { APIKLEStatusResponseDTO } from '../model/aPIKLEStatusResponseDTO';
...
export class APIV2KLEInternalINTERNALService {
   ...
   */
  public getSingleKLEInternalV2GetKLEChanges(
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleKLEInternalV2GetKLEStatus(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIKLEStatusResponseDTO>;
  public getSingleKLEInternalV2GetKLEStatus(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIKLEStatusResponseDTO>>;
  public getSingleKLEInternalV2GetKLEStatus(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIKLEStatusResponseDTO>>;
  public getSingleKLEInternalV2GetKLEStatus(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
    ...
    return this.httpClient.request<APIKLEStatusResponseDTO>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
      headers: localVarHeaders,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public putSingleKLEInternalV2PutKLEChanges(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: undefined; context?: HttpContext },
  ): Observable<any>;
