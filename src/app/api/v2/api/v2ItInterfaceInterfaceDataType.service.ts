...
export class APIV2ItInterfaceInterfaceDataTypeService {
   ...
   */
  public getManyItInterfaceInterfaceDataTypeV2Get(
    requestParameters: GetManyItInterfaceInterfaceDataTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItInterfaceInterfaceDataTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItInterfaceInterfaceDataTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItInterfaceInterfaceDataTypeV2GetV1(
    requestParameters: GetSingleItInterfaceInterfaceDataTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItInterfaceInterfaceDataTypeV2GetV1(
    ...
    if (interfaceDataTypeUuid === null || interfaceDataTypeUuid === undefined) {
      throw new Error(
        'Required parameter interfaceDataTypeUuid was null or undefined when calling getSingleItInterfaceInterfaceDataTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItInterfaceInterfaceDataTypeV2GetV1.',
      );
    }
