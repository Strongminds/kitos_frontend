...
export class APIV2ItContractContractTypeService {
   ...
   */
  public getManyItContractContractTypeV2Get(
    requestParameters: GetManyItContractContractTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItContractContractTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItContractContractTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractContractTypeV2GetV1(
    requestParameters: GetSingleItContractContractTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItContractContractTypeV2GetV1(
    ...
    if (contractTypeUuid === null || contractTypeUuid === undefined) {
      throw new Error(
        'Required parameter contractTypeUuid was null or undefined when calling getSingleItContractContractTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItContractContractTypeV2GetV1.',
      );
    }
