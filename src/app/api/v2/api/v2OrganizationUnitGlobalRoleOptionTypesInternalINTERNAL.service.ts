...
export interface PatchSingleOrganizationUnitGlobalRoleOptionTypesInternalV2PatchGlobalOrganizationUnitRoleRequestParams {
  optionUuid: string;
  dto: APIGlobalRoleOptionUpdateRequestDTO;
}

export interface PostSingleOrganizationUnitGlobalRoleOptionTypesInternalV2CreateOrganizationUnitRoleRequestParams {
...
export class APIV2OrganizationUnitGlobalRoleOptionTypesInternalINTERNALService {
   ...
   */
  public getManyOrganizationUnitGlobalRoleOptionTypesInternalV2GetOrganizationUnitRoles(
    observe?: 'body',
  ...
  public getManyOrganizationUnitGlobalRoleOptionTypesInternalV2GetOrganizationUnitRoles(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIGlobalRoleOptionResponseDTO>>>;
  public getManyOrganizationUnitGlobalRoleOptionTypesInternalV2GetOrganizationUnitRoles(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIGlobalRoleOptionResponseDTO>>>;
  public getManyOrganizationUnitGlobalRoleOptionTypesInternalV2GetOrganizationUnitRoles(
    observe: any = 'body',
    ...
    return this.httpClient.request<Array<APIGlobalRoleOptionResponseDTO>>(
      'get',
  ...
  public patchSingleOrganizationUnitGlobalRoleOptionTypesInternalV2PatchGlobalOrganizationUnitRole(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIGlobalRoleOptionResponseDTO>>;
  public patchSingleOrganizationUnitGlobalRoleOptionTypesInternalV2PatchGlobalOrganizationUnitRole(
    requestParameters: PatchSingleOrganizationUnitGlobalRoleOptionTypesInternalV2PatchGlobalOrganizationUnitRoleRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIGlobalRoleOptionResponseDTO>>;
  public patchSingleOrganizationUnitGlobalRoleOptionTypesInternalV2PatchGlobalOrganizationUnitRole(
    requestParameters: PatchSingleOrganizationUnitGlobalRoleOptionTypesInternalV2PatchGlobalOrganizationUnitRoleRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (optionUuid === null || optionUuid === undefined) {
      throw new Error(
        'Required parameter optionUuid was null or undefined when calling patchSingleOrganizationUnitGlobalRoleOptionTypesInternalV2PatchGlobalOrganizationUnitRole.',
      );
    }
    const dto = requestParameters.dto;
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling patchSingleOrganizationUnitGlobalRoleOptionTypesInternalV2PatchGlobalOrganizationUnitRole.',
      );
    }
    ...
    return this.httpClient.request<APIGlobalRoleOptionResponseDTO>(
      'patch',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleOrganizationUnitGlobalRoleOptionTypesInternalV2CreateOrganizationUnitRole(
    requestParameters: PostSingleOrganizationUnitGlobalRoleOptionTypesInternalV2CreateOrganizationUnitRoleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIGlobalRoleOptionResponseDTO>;
  ...
  public postSingleOrganizationUnitGlobalRoleOptionTypesInternalV2CreateOrganizationUnitRole(
    ...
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling postSingleOrganizationUnitGlobalRoleOptionTypesInternalV2CreateOrganizationUnitRole.',
      );
    }
