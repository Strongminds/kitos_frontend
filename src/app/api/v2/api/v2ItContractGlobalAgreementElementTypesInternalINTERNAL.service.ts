...
export interface PostSingleItContractGlobalAgreementElementTypesInternalV2CreateGlobalAgreementElementTypeRequestParams {
...
export class APIV2ItContractGlobalAgreementElementTypesInternalINTERNALService {
   ...
   */
  public getManyItContractGlobalAgreementElementTypesInternalV2GetGlobalAgreementElementTypes(
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public patchSingleItContractGlobalAgreementElementTypesInternalV2PatchGlobalAgreementElementType(
    requestParameters: PatchSingleItContractGlobalAgreementElementTypesInternalV2PatchGlobalAgreementElementTypeRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public patchSingleItContractGlobalAgreementElementTypesInternalV2PatchGlobalAgreementElementType(
    ...
    if (optionUuid === null || optionUuid === undefined) {
      throw new Error(
        'Required parameter optionUuid was null or undefined when calling patchSingleItContractGlobalAgreementElementTypesInternalV2PatchGlobalAgreementElementType.',
      );
    }
    const dto = requestParameters.dto;
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling patchSingleItContractGlobalAgreementElementTypesInternalV2PatchGlobalAgreementElementType.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleItContractGlobalAgreementElementTypesInternalV2CreateGlobalAgreementElementType(
    requestParameters: PostSingleItContractGlobalAgreementElementTypesInternalV2CreateGlobalAgreementElementTypeRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIGlobalRegularOptionResponseDTO>;
  ...
  public postSingleItContractGlobalAgreementElementTypesInternalV2CreateGlobalAgreementElementType(
    ...
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling postSingleItContractGlobalAgreementElementTypesInternalV2CreateGlobalAgreementElementType.',
      );
    }
