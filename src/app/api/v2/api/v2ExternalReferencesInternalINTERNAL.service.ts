...
export class APIV2ExternalReferencesInternalINTERNALService {
   ...
   */
  public getManyExternalReferencesInternalV2GetDataProcessingReferences(
    requestParameters: GetManyExternalReferencesInternalV2GetDataProcessingReferencesRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIExternalReferenceWithLastChangedResponseDTO>>;
  public getManyExternalReferencesInternalV2GetDataProcessingReferences(
    requestParameters: GetManyExternalReferencesInternalV2GetDataProcessingReferencesRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIExternalReferenceWithLastChangedResponseDTO>>>;
  public getManyExternalReferencesInternalV2GetDataProcessingReferences(
    requestParameters: GetManyExternalReferencesInternalV2GetDataProcessingReferencesRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIExternalReferenceWithLastChangedResponseDTO>>>;
  public getManyExternalReferencesInternalV2GetDataProcessingReferences(
    requestParameters: GetManyExternalReferencesInternalV2GetDataProcessingReferencesRequestParams,
    observe: any = 'body',
    ...
    if (dprUuid === null || dprUuid === undefined) {
      throw new Error(
        'Required parameter dprUuid was null or undefined when calling getManyExternalReferencesInternalV2GetDataProcessingReferences.',
      );
    }
    ...
    return this.httpClient.request<Array<APIExternalReferenceWithLastChangedResponseDTO>>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getManyExternalReferencesInternalV2GetItContractReferences(
    requestParameters: GetManyExternalReferencesInternalV2GetItContractReferencesRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIExternalReferenceWithLastChangedResponseDTO>>;
  ...
  public getManyExternalReferencesInternalV2GetItContractReferences(
    ...
    if (contractUuid === null || contractUuid === undefined) {
      throw new Error(
        'Required parameter contractUuid was null or undefined when calling getManyExternalReferencesInternalV2GetItContractReferences.',
      );
    }
  ...
  public getManyExternalReferencesInternalV2GetItSystemReferences(
    ...
    if (systemUuid === null || systemUuid === undefined) {
      throw new Error(
        'Required parameter systemUuid was null or undefined when calling getManyExternalReferencesInternalV2GetItSystemReferences.',
      );
    }
  ...
  public getManyExternalReferencesInternalV2GetItSystemUsageReferences(
    requestParameters: GetManyExternalReferencesInternalV2GetItSystemUsageReferencesRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIExternalReferenceWithLastChangedResponseDTO>>;
  ...
  public getManyExternalReferencesInternalV2GetItSystemUsageReferences(
    ...
    if (systemUsageUuid === null || systemUsageUuid === undefined) {
      throw new Error(
        'Required parameter systemUsageUuid was null or undefined when calling getManyExternalReferencesInternalV2GetItSystemUsageReferences.',
      );
    }
