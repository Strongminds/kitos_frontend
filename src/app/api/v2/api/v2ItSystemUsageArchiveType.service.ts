...
export class APIV2ItSystemUsageArchiveTypeService {
   ...
   */
  public getManyItSystemUsageArchiveTypeV2Get(
    requestParameters: GetManyItSystemUsageArchiveTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItSystemUsageArchiveTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageArchiveTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageArchiveTypeV2GetV1(
    requestParameters: GetSingleItSystemUsageArchiveTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItSystemUsageArchiveTypeV2GetV1(
    ...
    if (archiveTypeUuid === null || archiveTypeUuid === undefined) {
      throw new Error(
        'Required parameter archiveTypeUuid was null or undefined when calling getSingleItSystemUsageArchiveTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItSystemUsageArchiveTypeV2GetV1.',
      );
    }
