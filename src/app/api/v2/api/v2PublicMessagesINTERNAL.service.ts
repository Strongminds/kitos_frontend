...
export class APIV2PublicMessagesINTERNALService {
   ...
   */
  public getManyPublicMessagesV2Get(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIPublicMessageResponseDTO>>;
  public getManyPublicMessagesV2Get(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIPublicMessageResponseDTO>>>;
  public getManyPublicMessagesV2Get(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIPublicMessageResponseDTO>>>;
  public getManyPublicMessagesV2Get(
    observe: any = 'body',
    ...
    return this.httpClient.request<Array<APIPublicMessageResponseDTO>>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSinglePublicMessagesV2GetPermissions(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public patchSinglePublicMessagesV2Patch(
    requestParameters: PatchSinglePublicMessagesV2PatchRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIPublicMessageResponseDTO>;
  public patchSinglePublicMessagesV2Patch(
    requestParameters: PatchSinglePublicMessagesV2PatchRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIPublicMessageResponseDTO>>;
  public patchSinglePublicMessagesV2Patch(
    requestParameters: PatchSinglePublicMessagesV2PatchRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIPublicMessageResponseDTO>>;
  public patchSinglePublicMessagesV2Patch(
    requestParameters: PatchSinglePublicMessagesV2PatchRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (messageUuid === null || messageUuid === undefined) {
      throw new Error(
        'Required parameter messageUuid was null or undefined when calling patchSinglePublicMessagesV2Patch.',
      );
    }
    ...
    return this.httpClient.request<APIPublicMessageResponseDTO>(
      'patch',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSinglePublicMessagesV2Post(
    requestParameters: PostSinglePublicMessagesV2PostRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIPublicMessageResponseDTO>;
