...
export class APIV2OrganizationUnitRegistrationInternalINTERNALService {
   ...
   */
  public deleteSingleOrganizationUnitRegistrationInternalV2RemoveRegistrations(
    requestParameters: DeleteSingleOrganizationUnitRegistrationInternalV2RemoveRegistrationsRequestParams,
    observe?: 'body',
  ...
  public deleteSingleOrganizationUnitRegistrationInternalV2RemoveRegistrations(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling deleteSingleOrganizationUnitRegistrationInternalV2RemoveRegistrations.',
      );
    }
    const unitUuid = requestParameters.unitUuid;
    if (unitUuid === null || unitUuid === undefined) {
      throw new Error(
        'Required parameter unitUuid was null or undefined when calling deleteSingleOrganizationUnitRegistrationInternalV2RemoveRegistrations.',
      );
    }
    const requestDto = requestParameters.requestDto;
    if (requestDto === null || requestDto === undefined) {
      throw new Error(
        'Required parameter requestDto was null or undefined when calling deleteSingleOrganizationUnitRegistrationInternalV2RemoveRegistrations.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleOrganizationUnitRegistrationInternalV2GetRegistrations(
    requestParameters: GetSingleOrganizationUnitRegistrationInternalV2GetRegistrationsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIOrganizationRegistrationUnitResponseDTO>;
  public getSingleOrganizationUnitRegistrationInternalV2GetRegistrations(
    requestParameters: GetSingleOrganizationUnitRegistrationInternalV2GetRegistrationsRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIOrganizationRegistrationUnitResponseDTO>>;
  public getSingleOrganizationUnitRegistrationInternalV2GetRegistrations(
    requestParameters: GetSingleOrganizationUnitRegistrationInternalV2GetRegistrationsRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIOrganizationRegistrationUnitResponseDTO>>;
  public getSingleOrganizationUnitRegistrationInternalV2GetRegistrations(
    requestParameters: GetSingleOrganizationUnitRegistrationInternalV2GetRegistrationsRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleOrganizationUnitRegistrationInternalV2GetRegistrations.',
      );
    }
    const unitUuid = requestParameters.unitUuid;
    if (unitUuid === null || unitUuid === undefined) {
      throw new Error(
        'Required parameter unitUuid was null or undefined when calling getSingleOrganizationUnitRegistrationInternalV2GetRegistrations.',
      );
    }
    ...
    let localVarPath = `/api/v2/internal/organizations/${this.configuration.encodeParam({ name: 'organizationUuid', value: organizationUuid, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: 'uuid' })}/organization-units/${this.configuration.encodeParam({ name: 'unitUuid', value: unitUuid, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: 'uuid' })}/registrations`;
    return this.httpClient.request<APIOrganizationRegistrationUnitResponseDTO>(
      'get',
  ...
  public putSingleOrganizationUnitRegistrationInternalV2TransferRegistrations(
    requestParameters: PutSingleOrganizationUnitRegistrationInternalV2TransferRegistrationsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: undefined; context?: HttpContext },
  ): Observable<any>;
  ...
  public putSingleOrganizationUnitRegistrationInternalV2TransferRegistrations(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling putSingleOrganizationUnitRegistrationInternalV2TransferRegistrations.',
      );
    }
    const unitUuid = requestParameters.unitUuid;
    if (unitUuid === null || unitUuid === undefined) {
      throw new Error(
        'Required parameter unitUuid was null or undefined when calling putSingleOrganizationUnitRegistrationInternalV2TransferRegistrations.',
      );
    }
    const requestDto = requestParameters.requestDto;
    if (requestDto === null || requestDto === undefined) {
      throw new Error(
        'Required parameter requestDto was null or undefined when calling putSingleOrganizationUnitRegistrationInternalV2TransferRegistrations.',
      );
    }
