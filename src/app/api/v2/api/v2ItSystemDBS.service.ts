...
export class APIV2ItSystemDBSService {
   ...
   */
  public patchSingleItSystemDBSV2PatchDbsProperties(
    requestParameters: PatchSingleItSystemDBSV2PatchDbsPropertiesRequestParams,
    observe?: 'body',
  ...
  public patchSingleItSystemDBSV2PatchDbsProperties(
    ...
    if (systemUuid === null || systemUuid === undefined) {
      throw new Error(
        'Required parameter systemUuid was null or undefined when calling patchSingleItSystemDBSV2PatchDbsProperties.',
      );
    }
    const request = requestParameters.request;
    if (request === null || request === undefined) {
      throw new Error(
        'Required parameter request was null or undefined when calling patchSingleItSystemDBSV2PatchDbsProperties.',
      );
    }
