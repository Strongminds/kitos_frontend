...
export class APIV2ItSystemUsageDataClassificationTypeService {
   ...
   */
  public getManyItSystemUsageDataClassificationTypeV2Get(
    requestParameters: GetManyItSystemUsageDataClassificationTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItSystemUsageDataClassificationTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageDataClassificationTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageDataClassificationTypeV2GetV1(
    requestParameters: GetSingleItSystemUsageDataClassificationTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItSystemUsageDataClassificationTypeV2GetV1(
    ...
    if (dataClassificationTypeUuid === null || dataClassificationTypeUuid === undefined) {
      throw new Error(
        'Required parameter dataClassificationTypeUuid was null or undefined when calling getSingleItSystemUsageDataClassificationTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItSystemUsageDataClassificationTypeV2GetV1.',
      );
    }
