...
export interface GetManyDataProcessingRegistrationCountryTypeV2GetRequestParams {
...
export class APIV2DataProcessingRegistrationCountryTypeService {
     ...
     */
    public getManyDataProcessingRegistrationCountryTypeV2Get(requestParameters: GetManyDataProcessingRegistrationCountryTypeV2GetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<APIRegularOptionResponseDTO>>;
    public getManyDataProcessingRegistrationCountryTypeV2Get(requestParameters: GetManyDataProcessingRegistrationCountryTypeV2GetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<APIRegularOptionResponseDTO>>>;
    public getManyDataProcessingRegistrationCountryTypeV2Get(requestParameters: GetManyDataProcessingRegistrationCountryTypeV2GetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<APIRegularOptionResponseDTO>>>;
    public getManyDataProcessingRegistrationCountryTypeV2Get(requestParameters: GetManyDataProcessingRegistrationCountryTypeV2GetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const organizationUuid = requestParameters.organizationUuid;
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling getManyDataProcessingRegistrationCountryTypeV2Get.');
        }
