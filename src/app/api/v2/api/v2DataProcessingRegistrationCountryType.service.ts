...
export class APIV2DataProcessingRegistrationCountryTypeService {
   ...
   */
  public getManyDataProcessingRegistrationCountryTypeV2Get(
    requestParameters: GetManyDataProcessingRegistrationCountryTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyDataProcessingRegistrationCountryTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyDataProcessingRegistrationCountryTypeV2Get.',
      );
    }
  ...
  public getSingleDataProcessingRegistrationCountryTypeV2GetV1(
    requestParameters: GetSingleDataProcessingRegistrationCountryTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleDataProcessingRegistrationCountryTypeV2GetV1(
    ...
    if (countryUuid === null || countryUuid === undefined) {
      throw new Error(
        'Required parameter countryUuid was null or undefined when calling getSingleDataProcessingRegistrationCountryTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleDataProcessingRegistrationCountryTypeV2GetV1.',
      );
    }
