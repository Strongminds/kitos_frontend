...
export class APIV2ItSystemInternalINTERNALService {
   ...
   */
  public getManyItSystemInternalV2GetHierarchy(
    requestParameters: GetManyItSystemInternalV2GetHierarchyRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIItSystemHierarchyNodeResponseDTO>>;
  public getManyItSystemInternalV2GetHierarchy(
    requestParameters: GetManyItSystemInternalV2GetHierarchyRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIItSystemHierarchyNodeResponseDTO>>>;
  public getManyItSystemInternalV2GetHierarchy(
    requestParameters: GetManyItSystemInternalV2GetHierarchyRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIItSystemHierarchyNodeResponseDTO>>>;
  public getManyItSystemInternalV2GetHierarchy(
    requestParameters: GetManyItSystemInternalV2GetHierarchyRequestParams,
    observe: any = 'body',
    ...
    if (systemUuid === null || systemUuid === undefined) {
      throw new Error(
        'Required parameter systemUuid was null or undefined when calling getManyItSystemInternalV2GetHierarchy.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemInternalV2GetHierarchy.',
      );
    }
    ...
    return this.httpClient.request<Array<APIItSystemHierarchyNodeResponseDTO>>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getManyItSystemInternalV2GetItSystems(
    requestParameters: GetManyItSystemInternalV2GetItSystemsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIItSystemSearchResponseDTO>>;
  public getManyItSystemInternalV2GetItSystems(
    requestParameters: GetManyItSystemInternalV2GetItSystemsRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIItSystemSearchResponseDTO>>>;
  public getManyItSystemInternalV2GetItSystems(
    requestParameters: GetManyItSystemInternalV2GetItSystemsRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIItSystemSearchResponseDTO>>>;
  public getManyItSystemInternalV2GetItSystems(
    requestParameters: GetManyItSystemInternalV2GetItSystemsRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (excludeUuid !== undefined && excludeUuid !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>excludeUuid, 'excludeUuid');
    }
    if (excludeChildrenOfUuid !== undefined && excludeChildrenOfUuid !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        <any>excludeChildrenOfUuid,
        'excludeChildrenOfUuid',
      );
    }
    ...
    return this.httpClient.request<Array<APIItSystemSearchResponseDTO>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
