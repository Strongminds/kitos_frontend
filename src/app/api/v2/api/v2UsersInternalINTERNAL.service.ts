...
export interface GetManyUsersInternalV2GetUserByUuidRequestParams {
    organizationUuid: string;
    userUuid: string;
}
...
export class APIV2UsersInternalINTERNALService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getManyUsersInternalV2GetUserByUuid(requestParameters: GetManyUsersInternalV2GetUserByUuidRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<APIUserResponseDTO>>;
    public getManyUsersInternalV2GetUserByUuid(requestParameters: GetManyUsersInternalV2GetUserByUuidRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<APIUserResponseDTO>>>;
    public getManyUsersInternalV2GetUserByUuid(requestParameters: GetManyUsersInternalV2GetUserByUuidRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<APIUserResponseDTO>>>;
    public getManyUsersInternalV2GetUserByUuid(requestParameters: GetManyUsersInternalV2GetUserByUuidRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const organizationUuid = requestParameters.organizationUuid;
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling getManyUsersInternalV2GetUserByUuid.');
        }
        const userUuid = requestParameters.userUuid;
        if (userUuid === null || userUuid === undefined) {
            throw new Error('Required parameter userUuid was null or undefined when calling getManyUsersInternalV2GetUserByUuid.');
        }
        ...
        let localVarPath = `/api/v2/internal/organization/${this.configuration.encodeParam({name: "organizationUuid", value: organizationUuid, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}/users/${this.configuration.encodeParam({name: "userUuid", value: userUuid, in: "path", style: "simple", explode: false, dataType: "string", dataFormat: "uuid"})}`;
        return this.httpClient.request<Array<APIUserResponseDTO>>('get', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
