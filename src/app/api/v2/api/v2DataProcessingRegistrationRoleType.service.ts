...
export class APIV2DataProcessingRegistrationRoleTypeService {
   ...
   */
  public getManyDataProcessingRegistrationRoleTypeV2Get(
    requestParameters: GetManyDataProcessingRegistrationRoleTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyDataProcessingRegistrationRoleTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyDataProcessingRegistrationRoleTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingRegistrationRoleTypeV2GetV1(
    requestParameters: GetSingleDataProcessingRegistrationRoleTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleDataProcessingRegistrationRoleTypeV2GetV1(
    ...
    if (dataProcessingRegistrationRoleTypeUuid === null || dataProcessingRegistrationRoleTypeUuid === undefined) {
      throw new Error(
        'Required parameter dataProcessingRegistrationRoleTypeUuid was null or undefined when calling getSingleDataProcessingRegistrationRoleTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleDataProcessingRegistrationRoleTypeV2GetV1.',
      );
    }
