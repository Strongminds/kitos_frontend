...
export class APIV2ItSystemGlobalBusinessTypesInternalINTERNALService {
   ...
   */
  public getManyItSystemGlobalBusinessTypesInternalV2GetBusinessTypes(
    observe?: 'body',
  ...
  public patchSingleItSystemGlobalBusinessTypesInternalV2PatchGlobalBusinessType(
    ...
    if (optionUuid === null || optionUuid === undefined) {
      throw new Error(
        'Required parameter optionUuid was null or undefined when calling patchSingleItSystemGlobalBusinessTypesInternalV2PatchGlobalBusinessType.',
      );
    }
    const dto = requestParameters.dto;
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling patchSingleItSystemGlobalBusinessTypesInternalV2PatchGlobalBusinessType.',
      );
    }
  ...
  public postSingleItSystemGlobalBusinessTypesInternalV2CreateBusinessType(
    requestParameters: PostSingleItSystemGlobalBusinessTypesInternalV2CreateBusinessTypeRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIGlobalRegularOptionResponseDTO>;
  ...
  public postSingleItSystemGlobalBusinessTypesInternalV2CreateBusinessType(
    ...
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling postSingleItSystemGlobalBusinessTypesInternalV2CreateBusinessType.',
      );
    }
