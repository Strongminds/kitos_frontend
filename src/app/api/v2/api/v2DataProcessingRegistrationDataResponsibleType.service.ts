...
export class APIV2DataProcessingRegistrationDataResponsibleTypeService {
  ...
  public getManyDataProcessingRegistrationDataResponsibleTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyDataProcessingRegistrationDataResponsibleTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingRegistrationDataResponsibleTypeV2GetV1(
    requestParameters: GetSingleDataProcessingRegistrationDataResponsibleTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleDataProcessingRegistrationDataResponsibleTypeV2GetV1(
    ...
    if (dataResponsibleUuid === null || dataResponsibleUuid === undefined) {
      throw new Error(
        'Required parameter dataResponsibleUuid was null or undefined when calling getSingleDataProcessingRegistrationDataResponsibleTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleDataProcessingRegistrationDataResponsibleTypeV2GetV1.',
      );
    }
