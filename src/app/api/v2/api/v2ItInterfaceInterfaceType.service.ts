...
export class APIV2ItInterfaceInterfaceTypeService {
   ...
   */
  public getManyItInterfaceInterfaceTypeV2Get(
    requestParameters: GetManyItInterfaceInterfaceTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItInterfaceInterfaceTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItInterfaceInterfaceTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItInterfaceInterfaceTypeV2GetV1(
    requestParameters: GetSingleItInterfaceInterfaceTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItInterfaceInterfaceTypeV2GetV1(
    ...
    if (itInterfaceTypeUuid === null || itInterfaceTypeUuid === undefined) {
      throw new Error(
        'Required parameter itInterfaceTypeUuid was null or undefined when calling getSingleItInterfaceInterfaceTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItInterfaceInterfaceTypeV2GetV1.',
      );
    }
