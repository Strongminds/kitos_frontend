...
export interface GetManyItContractAgreementExtensionOptionTypeV2GetRequestParams {
    /** organization context for the agreement extension option types availability */
...
export class APIV2ItContractAgreementExtensionOptionTypeService {
     ...
     */
    public getManyItContractAgreementExtensionOptionTypeV2Get(requestParameters: GetManyItContractAgreementExtensionOptionTypeV2GetRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<APIRegularOptionResponseDTO>>;
    public getManyItContractAgreementExtensionOptionTypeV2Get(requestParameters: GetManyItContractAgreementExtensionOptionTypeV2GetRequestParams, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<APIRegularOptionResponseDTO>>>;
    public getManyItContractAgreementExtensionOptionTypeV2Get(requestParameters: GetManyItContractAgreementExtensionOptionTypeV2GetRequestParams, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<APIRegularOptionResponseDTO>>>;
    public getManyItContractAgreementExtensionOptionTypeV2Get(requestParameters: GetManyItContractAgreementExtensionOptionTypeV2GetRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const organizationUuid = requestParameters.organizationUuid;
        if (organizationUuid === null || organizationUuid === undefined) {
            throw new Error('Required parameter organizationUuid was null or undefined when calling getManyItContractAgreementExtensionOptionTypeV2Get.');
        }
