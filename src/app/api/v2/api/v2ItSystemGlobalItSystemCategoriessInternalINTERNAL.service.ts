...
export interface PatchSingleItSystemGlobalItSystemCategoriessInternalV2PatchGlobalItSystemCategoriesByOptionuuidRequestParams {
    optionUuid: string;
...
export class APIV2ItSystemGlobalItSystemCategoriessInternalINTERNALService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public patchSingleItSystemGlobalItSystemCategoriessInternalV2PatchGlobalItSystemCategoriesByOptionuuid(requestParameters: PatchSingleItSystemGlobalItSystemCategoriessInternalV2PatchGlobalItSystemCategoriesByOptionuuidRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<APIGlobalRegularOptionResponseDTO>;
    ...
    public patchSingleItSystemGlobalItSystemCategoriessInternalV2PatchGlobalItSystemCategoriesByOptionuuid(requestParameters: PatchSingleItSystemGlobalItSystemCategoriessInternalV2PatchGlobalItSystemCategoriesByOptionuuidRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (optionUuid === null || optionUuid === undefined) {
            throw new Error('Required parameter optionUuid was null or undefined when calling patchSingleItSystemGlobalItSystemCategoriessInternalV2PatchGlobalItSystemCategoriesByOptionuuid.');
        }
        const dto = requestParameters.dto;
        if (dto === null || dto === undefined) {
            throw new Error('Required parameter dto was null or undefined when calling patchSingleItSystemGlobalItSystemCategoriessInternalV2PatchGlobalItSystemCategoriesByOptionuuid.');
        }
