...
export class APIV2ItSystemGlobalRoleOptionTypesInternalINTERNALService {
   ...
   */
  public getManyItSystemGlobalRoleOptionTypesInternalV2GetItSystemRoles(
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public patchSingleItSystemGlobalRoleOptionTypesInternalV2PatchGlobalBItSystemRole(
    requestParameters: PatchSingleItSystemGlobalRoleOptionTypesInternalV2PatchGlobalBItSystemRoleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public patchSingleItSystemGlobalRoleOptionTypesInternalV2PatchGlobalBItSystemRole(
    ...
    if (optionUuid === null || optionUuid === undefined) {
      throw new Error(
        'Required parameter optionUuid was null or undefined when calling patchSingleItSystemGlobalRoleOptionTypesInternalV2PatchGlobalBItSystemRole.',
      );
    }
    const dto = requestParameters.dto;
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling patchSingleItSystemGlobalRoleOptionTypesInternalV2PatchGlobalBItSystemRole.',
      );
    }
  ...
  public postSingleItSystemGlobalRoleOptionTypesInternalV2CreateItSystemRole(
    requestParameters: PostSingleItSystemGlobalRoleOptionTypesInternalV2CreateItSystemRoleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIGlobalRoleOptionResponseDTO>;
  ...
  public postSingleItSystemGlobalRoleOptionTypesInternalV2CreateItSystemRole(
    ...
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling postSingleItSystemGlobalRoleOptionTypesInternalV2CreateItSystemRole.',
      );
    }
