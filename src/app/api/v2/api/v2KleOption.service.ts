...
// @ts-ignore
import { APIKLEDetailsDTOIEnumerableVersionedKLEResponseDTO } from '../model/aPIKLEDetailsDTOIEnumerableVersionedKLEResponseDTO';
// @ts-ignore
import { APIKLEDetailsDTOVersionedKLEResponseDTO } from '../model/aPIKLEDetailsDTOVersionedKLEResponseDTO';
...
export class APIV2KleOptionService {
   ...
   */
  public getSingleKleOptionV2Get(
    requestParameters: GetSingleKleOptionV2GetRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIKLEDetailsDTOVersionedKLEResponseDTO>;
  public getSingleKleOptionV2Get(
    requestParameters: GetSingleKleOptionV2GetRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIKLEDetailsDTOVersionedKLEResponseDTO>>;
  public getSingleKleOptionV2Get(
    requestParameters: GetSingleKleOptionV2GetRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIKLEDetailsDTOVersionedKLEResponseDTO>>;
  public getSingleKleOptionV2Get(
    requestParameters: GetSingleKleOptionV2GetRequestParams,
    observe: any = 'body',
    ...
    return this.httpClient.request<APIKLEDetailsDTOVersionedKLEResponseDTO>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleKleOptionV2GetV1(
    requestParameters: GetSingleKleOptionV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIKLEDetailsDTOIEnumerableVersionedKLEResponseDTO>;
  public getSingleKleOptionV2GetV1(
    requestParameters: GetSingleKleOptionV2GetV1RequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIKLEDetailsDTOIEnumerableVersionedKLEResponseDTO>>;
  public getSingleKleOptionV2GetV1(
    requestParameters: GetSingleKleOptionV2GetV1RequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIKLEDetailsDTOIEnumerableVersionedKLEResponseDTO>>;
  public getSingleKleOptionV2GetV1(
    requestParameters: GetSingleKleOptionV2GetV1RequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (parentKleUuid !== undefined && parentKleUuid !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>parentKleUuid, 'parentKleUuid');
    }
    if (parentKleNumber !== undefined && parentKleNumber !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>parentKleNumber, 'parentKleNumber');
    }
    if (kleNumberPrefix !== undefined && kleNumberPrefix !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>kleNumberPrefix, 'kleNumberPrefix');
    }
    if (kleDescriptionContent !== undefined && kleDescriptionContent !== null) {
      localVarQueryParameters = this.addToHttpParams(
        localVarQueryParameters,
        <any>kleDescriptionContent,
        'kleDescriptionContent',
      );
    }
    ...
    return this.httpClient.request<APIKLEDetailsDTOIEnumerableVersionedKLEResponseDTO>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
