...
export class APIV2ItContractCriticalityTypeService {
   ...
   */
  public getManyItContractCriticalityTypeV2Get(
    requestParameters: GetManyItContractCriticalityTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItContractCriticalityTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItContractCriticalityTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractCriticalityTypeV2GetV1(
    requestParameters: GetSingleItContractCriticalityTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItContractCriticalityTypeV2GetV1(
    ...
    if (criticalityTypeUuid === null || criticalityTypeUuid === undefined) {
      throw new Error(
        'Required parameter criticalityTypeUuid was null or undefined when calling getSingleItContractCriticalityTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItContractCriticalityTypeV2GetV1.',
      );
    }
