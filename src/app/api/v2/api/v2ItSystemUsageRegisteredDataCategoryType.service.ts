...
export class APIV2ItSystemUsageRegisteredDataCategoryTypeService {
  ...
  public getManyItSystemUsageRegisteredDataCategoryTypeV2Get(
    requestParameters: GetManyItSystemUsageRegisteredDataCategoryTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItSystemUsageRegisteredDataCategoryTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageRegisteredDataCategoryTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageRegisteredDataCategoryTypeV2GetV1(
    requestParameters: GetSingleItSystemUsageRegisteredDataCategoryTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItSystemUsageRegisteredDataCategoryTypeV2GetV1(
    ...
    if (registeredDataCatagoryTypeUuid === null || registeredDataCatagoryTypeUuid === undefined) {
      throw new Error(
        'Required parameter registeredDataCatagoryTypeUuid was null or undefined when calling getSingleItSystemUsageRegisteredDataCategoryTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItSystemUsageRegisteredDataCategoryTypeV2GetV1.',
      );
    }
