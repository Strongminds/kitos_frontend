...
export class APIV2GdprExportReportInternalINTERNALService {
   ...
   */
  public getManyGdprExportReportInternalV2GetGdprReport(
    requestParameters: GetManyGdprExportReportInternalV2GetGdprReportRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIGdprReportResponseDTO>>;
  public getManyGdprExportReportInternalV2GetGdprReport(
    requestParameters: GetManyGdprExportReportInternalV2GetGdprReportRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIGdprReportResponseDTO>>>;
  public getManyGdprExportReportInternalV2GetGdprReport(
    requestParameters: GetManyGdprExportReportInternalV2GetGdprReportRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIGdprReportResponseDTO>>>;
  public getManyGdprExportReportInternalV2GetGdprReport(
    requestParameters: GetManyGdprExportReportInternalV2GetGdprReportRequestParams,
    observe: any = 'body',
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyGdprExportReportInternalV2GetGdprReport.',
      );
    }
    ...
    return this.httpClient.request<Array<APIGdprReportResponseDTO>>(
      'get',
