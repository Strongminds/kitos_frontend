...
export class APIV2TokenService {
   ...
   */
  public postSingleTokenV2Introspect(
    requestParameters: PostSingleTokenV2IntrospectRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APITokenIntrospectionResponseDTO>;
  public postSingleTokenV2Introspect(
    requestParameters: PostSingleTokenV2IntrospectRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APITokenIntrospectionResponseDTO>>;
  public postSingleTokenV2Introspect(
    requestParameters: PostSingleTokenV2IntrospectRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APITokenIntrospectionResponseDTO>>;
  public postSingleTokenV2Introspect(
    requestParameters: PostSingleTokenV2IntrospectRequestParams,
    observe: any = 'body',
    ...
    return this.httpClient.request<APITokenIntrospectionResponseDTO>(
      'post',
