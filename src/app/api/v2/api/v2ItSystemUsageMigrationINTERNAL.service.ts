...
export class APIV2ItSystemUsageMigrationINTERNALService {
   ...
   */
  public getManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganization(
    requestParameters: GetManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganizationRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIIdentityNamePairWithDeactivatedStatusDTO>>;
  public getManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganization(
    requestParameters: GetManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganizationRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIIdentityNamePairWithDeactivatedStatusDTO>>>;
  public getManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganization(
    requestParameters: GetManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganizationRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIIdentityNamePairWithDeactivatedStatusDTO>>>;
  public getManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganization(
    requestParameters: GetManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganizationRequestParams,
    observe: any = 'body',
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganization.',
      );
    }
    const numberOfItSystems = requestParameters.numberOfItSystems;
    if (numberOfItSystems === null || numberOfItSystems === undefined) {
      throw new Error(
        'Required parameter numberOfItSystems was null or undefined when calling getManyItSystemUsageMigrationV2GetUnusedItSystemsBySearchAndOrganization.',
      );
    }
    ...
    return this.httpClient.request<Array<APIIdentityNamePairWithDeactivatedStatusDTO>>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageMigrationV2Get(
    requestParameters: GetSingleItSystemUsageMigrationV2GetRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIItSystemUsageMigrationV2ResponseDTO>;
  public getSingleItSystemUsageMigrationV2Get(
    requestParameters: GetSingleItSystemUsageMigrationV2GetRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIItSystemUsageMigrationV2ResponseDTO>>;
  public getSingleItSystemUsageMigrationV2Get(
    requestParameters: GetSingleItSystemUsageMigrationV2GetRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIItSystemUsageMigrationV2ResponseDTO>>;
  public getSingleItSystemUsageMigrationV2Get(
    requestParameters: GetSingleItSystemUsageMigrationV2GetRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (usageUuid === null || usageUuid === undefined) {
      throw new Error(
        'Required parameter usageUuid was null or undefined when calling getSingleItSystemUsageMigrationV2Get.',
      );
    }
    const toSystemUuid = requestParameters.toSystemUuid;
    if (toSystemUuid === null || toSystemUuid === undefined) {
      throw new Error(
        'Required parameter toSystemUuid was null or undefined when calling getSingleItSystemUsageMigrationV2Get.',
      );
    }

    let localVarQueryParameters = new HttpParams({ encoder: this.encoder });
    if (toSystemUuid !== undefined && toSystemUuid !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>toSystemUuid, 'toSystemUuid');
    }
    ...
    return this.httpClient.request<APIItSystemUsageMigrationV2ResponseDTO>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageMigrationV2GetPermissions(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIItSystemUsageMigrationPermissionsResponseDTO>;
  public getSingleItSystemUsageMigrationV2GetPermissions(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIItSystemUsageMigrationPermissionsResponseDTO>>;
  public getSingleItSystemUsageMigrationV2GetPermissions(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIItSystemUsageMigrationPermissionsResponseDTO>>;
  public getSingleItSystemUsageMigrationV2GetPermissions(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
    ...
    return this.httpClient.request<APIItSystemUsageMigrationPermissionsResponseDTO>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleItSystemUsageMigrationV2ExecuteMigration(
    requestParameters: PostSingleItSystemUsageMigrationV2ExecuteMigrationRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public postSingleItSystemUsageMigrationV2ExecuteMigration(
    ...
    if (usageUuid === null || usageUuid === undefined) {
      throw new Error(
        'Required parameter usageUuid was null or undefined when calling postSingleItSystemUsageMigrationV2ExecuteMigration.',
      );
    }
    const toSystemUuid = requestParameters.toSystemUuid;
    if (toSystemUuid === null || toSystemUuid === undefined) {
      throw new Error(
        'Required parameter toSystemUuid was null or undefined when calling postSingleItSystemUsageMigrationV2ExecuteMigration.',
      );
    }
