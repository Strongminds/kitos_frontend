...
export interface PatchSingleItSystemGlobalSensitivePersonalDatasInternalV2PatchGlobalSensitivePersonalDataByOptionuuidRequestParams {
    optionUuid: string;
...
export class APIV2ItSystemGlobalSensitivePersonalDatasInternalINTERNALService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public patchSingleItSystemGlobalSensitivePersonalDatasInternalV2PatchGlobalSensitivePersonalDataByOptionuuid(requestParameters: PatchSingleItSystemGlobalSensitivePersonalDatasInternalV2PatchGlobalSensitivePersonalDataByOptionuuidRequestParams, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<APIGlobalRegularOptionResponseDTO>;
    ...
    public patchSingleItSystemGlobalSensitivePersonalDatasInternalV2PatchGlobalSensitivePersonalDataByOptionuuid(requestParameters: PatchSingleItSystemGlobalSensitivePersonalDatasInternalV2PatchGlobalSensitivePersonalDataByOptionuuidRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (optionUuid === null || optionUuid === undefined) {
            throw new Error('Required parameter optionUuid was null or undefined when calling patchSingleItSystemGlobalSensitivePersonalDatasInternalV2PatchGlobalSensitivePersonalDataByOptionuuid.');
        }
        const dto = requestParameters.dto;
        if (dto === null || dto === undefined) {
            throw new Error('Required parameter dto was null or undefined when calling patchSingleItSystemGlobalSensitivePersonalDatasInternalV2PatchGlobalSensitivePersonalDataByOptionuuid.');
        }
