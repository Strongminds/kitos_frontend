...
export class APIV2DprGlobalRoleOptionTypesInternalINTERNALService {
   ...
   */
  public getManyDprGlobalRoleOptionTypesInternalV2GetDprRoles(
    observe?: 'body',
  ...
  public patchSingleDprGlobalRoleOptionTypesInternalV2PatchDprRole(
    ...
    if (optionUuid === null || optionUuid === undefined) {
      throw new Error(
        'Required parameter optionUuid was null or undefined when calling patchSingleDprGlobalRoleOptionTypesInternalV2PatchDprRole.',
      );
    }
    const dto = requestParameters.dto;
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling patchSingleDprGlobalRoleOptionTypesInternalV2PatchDprRole.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleDprGlobalRoleOptionTypesInternalV2CreateDprRole(
    requestParameters: PostSingleDprGlobalRoleOptionTypesInternalV2CreateDprRoleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIGlobalRoleOptionResponseDTO>;
  ...
  public postSingleDprGlobalRoleOptionTypesInternalV2CreateDprRole(
    ...
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling postSingleDprGlobalRoleOptionTypesInternalV2CreateDprRole.',
      );
    }
