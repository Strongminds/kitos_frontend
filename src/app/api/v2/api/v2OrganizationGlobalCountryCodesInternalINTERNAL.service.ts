...
export class APIV2OrganizationGlobalCountryCodesInternalINTERNALService {
   ...
   */
  public getManyOrganizationGlobalCountryCodesInternalV2GetCountryCodes(
    observe?: 'body',
  ...
  public patchSingleOrganizationGlobalCountryCodesInternalV2PatchCountryCode(
    requestParameters: PatchSingleOrganizationGlobalCountryCodesInternalV2PatchCountryCodeRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public patchSingleOrganizationGlobalCountryCodesInternalV2PatchCountryCode(
    ...
    if (optionUuid === null || optionUuid === undefined) {
      throw new Error(
        'Required parameter optionUuid was null or undefined when calling patchSingleOrganizationGlobalCountryCodesInternalV2PatchCountryCode.',
      );
    }
    const dto = requestParameters.dto;
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling patchSingleOrganizationGlobalCountryCodesInternalV2PatchCountryCode.',
      );
    }
  ...
  public postSingleOrganizationGlobalCountryCodesInternalV2CreateCountryCode(
    requestParameters: PostSingleOrganizationGlobalCountryCodesInternalV2CreateCountryCodeRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIGlobalRegularOptionResponseDTO>;
  ...
  public postSingleOrganizationGlobalCountryCodesInternalV2CreateCountryCode(
    ...
    if (dto === null || dto === undefined) {
      throw new Error(
        'Required parameter dto was null or undefined when calling postSingleOrganizationGlobalCountryCodesInternalV2CreateCountryCode.',
      );
    }
