...
export interface PostSingleHelpTextsInternalV2PostRequestParams {
  dto: APIHelpTextCreateRequestDTO;
}

@Injectable({
  providedIn: 'root',
})
export class APIV2HelpTextsInternalINTERNALService {
   ...
   */
  public deleteSingleHelpTextsInternalV2Delete(
    requestParameters: DeleteSingleHelpTextsInternalV2DeleteRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIHelpTextResponseDTO>;
  public deleteSingleHelpTextsInternalV2Delete(
    requestParameters: DeleteSingleHelpTextsInternalV2DeleteRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpResponse<APIHelpTextResponseDTO>>;
  public deleteSingleHelpTextsInternalV2Delete(
    requestParameters: DeleteSingleHelpTextsInternalV2DeleteRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpEvent<APIHelpTextResponseDTO>>;
  public deleteSingleHelpTextsInternalV2Delete(
    requestParameters: DeleteSingleHelpTextsInternalV2DeleteRequestParams,
    observe: any = 'body',
    ...
    if (key === null || key === undefined) {
      throw new Error(
        'Required parameter key was null or undefined when calling deleteSingleHelpTextsInternalV2Delete.',
      );
    }
    ...
    return this.httpClient.request<APIHelpTextResponseDTO>('delete', `${this.configuration.basePath}${localVarPath}`, {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getManyHelpTextsInternalV2GetAll(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIHelpTextResponseDTO>>;
  public getManyHelpTextsInternalV2GetAll(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIHelpTextResponseDTO>>>;
  public getManyHelpTextsInternalV2GetAll(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIHelpTextResponseDTO>>>;
  public getManyHelpTextsInternalV2GetAll(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
    ...
    return this.httpClient.request<Array<APIHelpTextResponseDTO>>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleHelpTextsInternalV2GetSingle(
    requestParameters: GetSingleHelpTextsInternalV2GetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIHelpTextResponseDTO>;
  ...
  public getSingleHelpTextsInternalV2GetSingle(
    ...
    if (key === null || key === undefined) {
      throw new Error(
        'Required parameter key was null or undefined when calling getSingleHelpTextsInternalV2GetSingle.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public patchSingleHelpTextsInternalV2Patch(
    requestParameters: PatchSingleHelpTextsInternalV2PatchRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIHelpTextResponseDTO>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleHelpTextsInternalV2Post(
    requestParameters: PostSingleHelpTextsInternalV2PostRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<APIHelpTextResponseDTO>;
  ...
  public postSingleHelpTextsInternalV2Post(
    ...
    const dto = requestParameters.dto;
    if (dto === null || dto === undefined) {
      throw new Error('Required parameter dto was null or undefined when calling postSingleHelpTextsInternalV2Post.');
    }
