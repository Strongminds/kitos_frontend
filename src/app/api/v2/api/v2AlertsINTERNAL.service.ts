...
export class APIV2AlertsINTERNALService {
   ...
   */
  public deleteSingleAlertsV2DeleteAlert(
    requestParameters: DeleteSingleAlertsV2DeleteAlertRequestParams,
    observe?: 'body',
  ...
  public deleteSingleAlertsV2DeleteAlert(
    ...
    if (alertUuid === null || alertUuid === undefined) {
      throw new Error(
        'Required parameter alertUuid was null or undefined when calling deleteSingleAlertsV2DeleteAlert.',
      );
    }
    ...
    let localVarPath = `/api/v2/internal/alerts/${this.configuration.encodeParam({ name: 'alertUuid', value: alertUuid, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: 'uuid' })}`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getManyAlertsV2GetByOrganizationAndUser(
    requestParameters: GetManyAlertsV2GetByOrganizationAndUserRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<Array<APIAlertResponseDTO>>;
  public getManyAlertsV2GetByOrganizationAndUser(
    requestParameters: GetManyAlertsV2GetByOrganizationAndUserRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpResponse<Array<APIAlertResponseDTO>>>;
  public getManyAlertsV2GetByOrganizationAndUser(
    requestParameters: GetManyAlertsV2GetByOrganizationAndUserRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<HttpEvent<Array<APIAlertResponseDTO>>>;
  public getManyAlertsV2GetByOrganizationAndUser(
    requestParameters: GetManyAlertsV2GetByOrganizationAndUserRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyAlertsV2GetByOrganizationAndUser.',
      );
    }
    const userUuid = requestParameters.userUuid;
    if (userUuid === null || userUuid === undefined) {
      throw new Error(
        'Required parameter userUuid was null or undefined when calling getManyAlertsV2GetByOrganizationAndUser.',
      );
    }
    const relatedEntityType = requestParameters.relatedEntityType;
    if (relatedEntityType === null || relatedEntityType === undefined) {
      throw new Error(
        'Required parameter relatedEntityType was null or undefined when calling getManyAlertsV2GetByOrganizationAndUser.',
      );
    }
    ...
    let localVarPath = `/api/v2/internal/alerts/organization/${this.configuration.encodeParam({ name: 'organizationUuid', value: organizationUuid, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: 'uuid' })}/user/${this.configuration.encodeParam({ name: 'userUuid', value: userUuid, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: 'uuid' })}/${this.configuration.encodeParam({ name: 'relatedEntityType', value: relatedEntityType, in: 'path', style: 'simple', explode: false, dataType: "'itContract' | 'itSystemUsage' | 'dataProcessingRegistration'", dataFormat: undefined })}`;
