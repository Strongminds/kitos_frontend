...
export class APIV2ItContractGlobalPriceRegulationTypesInternalINTERNALService {
     ...
     */
    public getManyItContractGlobalPriceRegulationTypesInternalV2GetGlobalPriceRegulationTypes(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<APIGlobalRegularOptionResponseDTO>>;
    public getManyItContractGlobalPriceRegulationTypesInternalV2GetGlobalPriceRegulationTypes(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<APIGlobalRegularOptionResponseDTO>>>;
    public getManyItContractGlobalPriceRegulationTypesInternalV2GetGlobalPriceRegulationTypes(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<APIGlobalRegularOptionResponseDTO>>>;
    public getManyItContractGlobalPriceRegulationTypesInternalV2GetGlobalPriceRegulationTypes(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
    ...
    public postSingleItContractGlobalPriceRegulationTypesInternalV2CreateGlobalPriceRegulationType(requestParameters: PostSingleItContractGlobalPriceRegulationTypesInternalV2CreateGlobalPriceRegulationTypeRequestParams, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        const dto = requestParameters.dto;
        if (dto === null || dto === undefined) {
            throw new Error('Required parameter dto was null or undefined when calling postSingleItContractGlobalPriceRegulationTypesInternalV2CreateGlobalPriceRegulationType.');
        }
