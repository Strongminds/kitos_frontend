...
export class APIV2DataProcessingRegistrationOversightTypeService {
  ...
  public getManyDataProcessingRegistrationOversightTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyDataProcessingRegistrationOversightTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingRegistrationOversightTypeV2GetV1(
    requestParameters: GetSingleDataProcessingRegistrationOversightTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleDataProcessingRegistrationOversightTypeV2GetV1(
    ...
    if (oversightUuid === null || oversightUuid === undefined) {
      throw new Error(
        'Required parameter oversightUuid was null or undefined when calling getSingleDataProcessingRegistrationOversightTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleDataProcessingRegistrationOversightTypeV2GetV1.',
      );
    }
