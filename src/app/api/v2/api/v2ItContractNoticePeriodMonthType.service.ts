...
export class APIV2ItContractNoticePeriodMonthTypeService {
   ...
   */
  public getManyItContractNoticePeriodMonthTypeV2Get(
    requestParameters: GetManyItContractNoticePeriodMonthTypeV2GetRequestParams,
    observe?: 'body',
  ...
  public getManyItContractNoticePeriodMonthTypeV2Get(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getManyItContractNoticePeriodMonthTypeV2Get.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractNoticePeriodMonthTypeV2GetV1(
    requestParameters: GetSingleItContractNoticePeriodMonthTypeV2GetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ...
  public getSingleItContractNoticePeriodMonthTypeV2GetV1(
    ...
    if (noticePeriodMonthTypeUuid === null || noticePeriodMonthTypeUuid === undefined) {
      throw new Error(
        'Required parameter noticePeriodMonthTypeUuid was null or undefined when calling getSingleItContractNoticePeriodMonthTypeV2GetV1.',
      );
    }
    const organizationUuid = requestParameters.organizationUuid;
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItContractNoticePeriodMonthTypeV2GetV1.',
      );
    }
