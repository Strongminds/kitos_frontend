...
export namespace APIItSystemUsageOverviewSensitiveDataLevelReadModel {
  ...
  export const SensitivityDataLevelEnum = {
    ...
    Personaldata: 'PERSONALDATA' as SensitivityDataLevelEnum,
    Sensitivedata: 'SENSITIVEDATA' as SensitivityDataLevelEnum,
    Legaldata: 'LEGALDATA' as SensitivityDataLevelEnum,
  };
}
