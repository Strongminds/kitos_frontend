...
export class APIV1ODATAOrganizationUnitRolesINTERNALService {
   ...
   */
  public getSingleOrganizationUnitRolesGetV1(
    requestParameters: GetSingleOrganizationUnitRolesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleOrganizationUnitRolesGetV1(
    ...
    let localVarPath = `/odata/OrganizationUnitRoles`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleOrganizationUnitRolesGetV1ById(
    requestParameters: GetSingleOrganizationUnitRolesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleOrganizationUnitRolesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleOrganizationUnitRolesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/OrganizationUnitRoles(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
