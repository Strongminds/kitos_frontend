...
export class APIV1ODATAAdviceSentINTERNALService {
   ...
   */
  public getSingleAdviceSentGet(
    requestParameters: GetSingleAdviceSentGetRequestParams,
    observe?: 'body',
  ...
  public getSingleAdviceSentGet(
    ...
    let localVarPath = `/odata/AdviceSent`;
