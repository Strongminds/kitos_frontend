...
export class APIV1ODATALocalDataProcessingBasisForTransferOptionsINTERNALService {
  ...
  public getSingleLocalDataProcessingBasisForTransferOptionsGetByOrganizationId(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleLocalDataProcessingBasisForTransferOptionsGetByOrganizationId.',
      );
    }
    ...
    let localVarPath = `/odata/LocalDataProcessingBasisForTransferOptions`;
