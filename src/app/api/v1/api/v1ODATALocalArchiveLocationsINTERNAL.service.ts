...
export class APIV1ODATALocalArchiveLocationsINTERNALService {
   ...
   */
  public getSingleLocalArchiveLocationsGetByOrganizationId(
    requestParameters: GetSingleLocalArchiveLocationsGetByOrganizationIdRequestParams,
    observe?: 'body',
  ...
  public getSingleLocalArchiveLocationsGetByOrganizationId(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleLocalArchiveLocationsGetByOrganizationId.',
      );
    }
    ...
    let localVarPath = `/odata/LocalArchiveLocations`;
