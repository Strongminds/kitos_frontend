...
export class APIV1TaskRefINTERNALService {
   ...
   */
  public getSingleTaskRefGetChildren(
    requestParameters: GetSingleTaskRefGetChildrenRequestParams,
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleTaskRefGetRoots(
    requestParameters: GetSingleTaskRefGetRootsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleTaskRefGetRoots(
    ...
    if (roots !== undefined && roots !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>roots, 'roots');
    }
    if (take !== undefined && take !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>take, 'take');
    }
