...
// @ts-ignore
import { APIContactPersonDTOApiReturnDTO } from '../model/aPIContactPersonDTOApiReturnDTO';
...
export interface GetSingleContactpersonGetSingleRequestParams {
  id: number;
}
...
export class APIV1ContactpersonINTERNALService {
   ...
   */
  public getSingleContactpersonGetAll(
    requestParameters: GetSingleContactpersonGetAllRequestParams,
    observe?: 'body',
  ...
  public getSingleContactpersonGetAll(
    ...
    let localVarPath = `/api/Contactperson`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleContactpersonGetSingle(
    requestParameters: GetSingleContactpersonGetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIContactPersonDTOApiReturnDTO>;
  public getSingleContactpersonGetSingle(
    requestParameters: GetSingleContactpersonGetSingleRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIContactPersonDTOApiReturnDTO>>;
  public getSingleContactpersonGetSingle(
    requestParameters: GetSingleContactpersonGetSingleRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIContactPersonDTOApiReturnDTO>>;
  public getSingleContactpersonGetSingle(
    requestParameters: GetSingleContactpersonGetSingleRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSingleContactpersonGetSingle.');
    }
    ...
    let localVarPath = `/api/Contactperson/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })}`;
    return this.httpClient.request<APIContactPersonDTOApiReturnDTO>(
      'get',
