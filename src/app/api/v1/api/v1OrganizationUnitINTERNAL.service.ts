...
export class APIV1OrganizationUnitINTERNALService {
   ...
   */
  public getSingleOrganizationUnitGetByUser(
    requestParameters: GetSingleOrganizationUnitGetByUserRequestParams,
    observe?: 'body',
  ...
  public getSingleOrganizationUnitGetByUser(
    ...
    if (byUser === null || byUser === undefined) {
      throw new Error(
        'Required parameter byUser was null or undefined when calling getSingleOrganizationUnitGetByUser.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleOrganizationUnitGetByUser.',
      );
    }

    let localVarQueryParameters = new HttpParams({ encoder: this.encoder });
    if (byUser !== undefined && byUser !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>byUser, 'byUser');
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleOrganizationUnitGetChildren(
    requestParameters: GetSingleOrganizationUnitGetChildrenRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleOrganizationUnitGetChildren(
    ...
    if (children === null || children === undefined) {
      throw new Error(
        'Required parameter children was null or undefined when calling getSingleOrganizationUnitGetChildren.',
      );
    }
    ...
    if (children !== undefined && children !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>children, 'children');
    }
