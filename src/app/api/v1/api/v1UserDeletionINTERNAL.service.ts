...
export interface GetSingleUserDeletionGetAccessRightsRequestParams {
...
export class APIV1UserDeletionINTERNALService {
   ...
   */
  public getSingleUserDeletionGetAccessRights(
    requestParameters: GetSingleUserDeletionGetAccessRightsRequestParams,
    observe?: 'body',
  ...
  public getSingleUserDeletionGetAccessRights(
    ...
    if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntitiesAccessRights was null or undefined when calling getSingleUserDeletionGetAccessRights.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleUserDeletionGetAccessRights.',
      );
    }
    ...
    let localVarPath = `/api/UserDeletion`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUserDeletionGetAccessRightsForEntity(
    requestParameters: GetSingleUserDeletionGetAccessRightsForEntityRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleUserDeletionGetAccessRightsForEntity(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleUserDeletionGetAccessRightsForEntity.',
      );
    }
    ...
    if (getEntityAccessRights === null || getEntityAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntityAccessRights was null or undefined when calling getSingleUserDeletionGetAccessRightsForEntity.',
      );
    }
    ...
    let localVarPath = `/api/UserDeletion/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })}`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
