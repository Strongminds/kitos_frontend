...
export class APIV1ODATALocalOptionExtendTypesINTERNALService {
   ...
   */
  public getSingleLocalOptionExtendTypesGetByOrganizationId(
    requestParameters: GetSingleLocalOptionExtendTypesGetByOrganizationIdRequestParams,
    observe?: 'body',
  ...
  public getSingleLocalOptionExtendTypesGetByOrganizationId(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleLocalOptionExtendTypesGetByOrganizationId.',
      );
    }
