...
export interface GetSingleItContractAgreementElementTypesGetRequestParams {
...
export class APIV1ODATAItContractAgreementElementTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet ItContractAgreementElementTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractAgreementElementTypesGet(
    requestParameters: GetSingleItContractAgreementElementTypesGetRequestParams,
    observe?: 'body',
  ...
  public getSingleItContractAgreementElementTypesGet(
    ...
    let localVarPath = `/odata/ItContractAgreementElementTypes`;
