...
export interface GetSinglePurchaseFormTypesGetV1RequestParams {
...
export interface GetSinglePurchaseFormTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAPurchaseFormTypesINTERNALService {
   ...
   */
  public getSinglePurchaseFormTypesGetV1(
    requestParameters: GetSinglePurchaseFormTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSinglePurchaseFormTypesGetV1(
    ...
    let localVarPath = `/odata/PurchaseFormTypes`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSinglePurchaseFormTypesGetV1ById(
    requestParameters: GetSinglePurchaseFormTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSinglePurchaseFormTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSinglePurchaseFormTypesGetV1ById.');
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/PurchaseFormTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
