...
export class APIV1ODATALocalBusinessTypesINTERNALService {
   ...
   */
  public getSingleLocalBusinessTypesGetByOrganizationId(
    requestParameters: GetSingleLocalBusinessTypesGetByOrganizationIdRequestParams,
    observe?: 'body',
  ...
  public getSingleLocalBusinessTypesGetByOrganizationId(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleLocalBusinessTypesGetByOrganizationId.',
      );
    }
    ...
    let localVarPath = `/odata/LocalBusinessTypes`;
