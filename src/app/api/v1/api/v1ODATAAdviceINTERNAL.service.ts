...
export class APIV1ODATAAdviceINTERNALService {
  ...
  /**
   * Call operation import  GetAdvicesByOrganizationId
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleAdviceGetAdvicesByOrganizationId(
    requestParameters: GetSingleAdviceGetAdvicesByOrganizationIdRequestParams,
    observe?: 'body',
  ...
  public getSingleAdviceGetAdvicesByOrganizationId(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleAdviceGetAdvicesByOrganizationId.',
      );
    }
    ...
    let localVarPath = `/odata/GetAdvicesByOrganizationId(organizationId=${this.configuration.encodeParam({ name: 'organizationId', value: organizationId, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
  ...
  /**
   * Returns the entity with the key from Advice
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleAdviceGetV1ById(
    requestParameters: GetSingleAdviceGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleAdviceGetV1ById(
    ...
    let localVarPath = `/odata/Advice(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
