...
export class APIV1OrganizationINTERNALService {
   ...
   */
  public getSingleOrganizationGet(
    requestParameters: GetSingleOrganizationGetRequestParams,
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleOrganizationGetSingle(
    requestParameters: GetSingleOrganizationGetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
