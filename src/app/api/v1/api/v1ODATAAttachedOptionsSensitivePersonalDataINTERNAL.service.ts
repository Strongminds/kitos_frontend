...
export class APIV1ODATAAttachedOptionsSensitivePersonalDataINTERNALService {
  ...
  public getSingleAttachedOptionsSensitivePersonalDataGetSensitivePersonalDataByUsageId(
    requestParameters: GetSingleAttachedOptionsSensitivePersonalDataGetSensitivePersonalDataByUsageIdRequestParams,
    observe?: 'body',
  ...
  public getSingleAttachedOptionsSensitivePersonalDataGetSensitivePersonalDataByUsageId(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleAttachedOptionsSensitivePersonalDataGetSensitivePersonalDataByUsageId.',
      );
    }
    ...
    let localVarPath = `/odata/GetSensitivePersonalDataByUsageId(id=${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
