...
export class APIV1ODATAItContractsINTERNALService {
   ...
   */
  public getSingleItContractsGet(
    requestParameters: GetSingleItContractsGetRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIItContractIQueryableODataResponse>;
  public getSingleItContractsGet(
    requestParameters: GetSingleItContractsGetRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpResponse<APIItContractIQueryableODataResponse>>;
  public getSingleItContractsGet(
    requestParameters: GetSingleItContractsGetRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpEvent<APIItContractIQueryableODataResponse>>;
  public getSingleItContractsGet(
    requestParameters: GetSingleItContractsGetRequestParams,
    observe: any = 'body',
    ...
    return this.httpClient.request<APIItContractIQueryableODataResponse>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractsGetItContractsByKey(
    requestParameters: GetSingleItContractsGetItContractsByKeyRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIItContractIQueryableODataResponse>;
  ...
  public getSingleItContractsGetItContractsByKey(
    ...
    if (key === null || key === undefined) {
      throw new Error(
        'Required parameter key was null or undefined when calling getSingleItContractsGetItContractsByKey.',
      );
    }
    const $expand = requestParameters.$expand;
    const $filter = requestParameters.$filter;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractsGetV1ById(
    requestParameters: GetSingleItContractsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
