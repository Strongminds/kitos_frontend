...
export interface GetSinglePaymentModelTypesGetV1RequestParams {
...
export interface GetSinglePaymentModelTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAPaymentModelTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet PaymentModelTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSinglePaymentModelTypesGetV1(
    requestParameters: GetSinglePaymentModelTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSinglePaymentModelTypesGetV1(
    ...
    let localVarPath = `/odata/PaymentModelTypes`;
  ...
  /**
   * Returns the entity with the key from PaymentModelTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSinglePaymentModelTypesGetV1ById(
    requestParameters: GetSinglePaymentModelTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSinglePaymentModelTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSinglePaymentModelTypesGetV1ById.');
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/PaymentModelTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
