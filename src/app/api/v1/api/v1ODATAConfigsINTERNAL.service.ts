...
export interface GetSingleConfigsGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
...
export class APIV1ODATAConfigsINTERNALService {
  ...
  /**
   * Returns the entity with the key from Configs
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleConfigsGetV1ById(
    requestParameters: GetSingleConfigsGetV1ByIdRequestParams,
    observe?: 'body',
  ...
  public getSingleConfigsGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSingleConfigsGetV1ById.');
    }
    ...
    let localVarPath = `/odata/Configs(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
