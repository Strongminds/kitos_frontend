...
export class APIV1ODATAOrganizationRightsINTERNALService {
   ...
   */
  public getSingleOrganizationRightsGetRightsByOrgkey(
    requestParameters: GetSingleOrganizationRightsGetRightsByOrgkeyRequestParams,
    observe?: 'body',
  ...
  public getSingleOrganizationRightsGetRightsByOrgkey(
    ...
    if (orgKey === null || orgKey === undefined) {
      throw new Error(
        'Required parameter orgKey was null or undefined when calling getSingleOrganizationRightsGetRightsByOrgkey.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleOrganizationRightsGetV1(
    requestParameters: GetSingleOrganizationRightsGetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleOrganizationRightsGetV1(
    ...
    let localVarPath = `/odata/OrganizationRights`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleOrganizationRightsGetV1ById(
    requestParameters: GetSingleOrganizationRightsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
