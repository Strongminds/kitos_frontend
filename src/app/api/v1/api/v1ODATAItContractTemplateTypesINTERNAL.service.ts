...
export interface GetSingleItContractTemplateTypesGetV1RequestParams {
...
export interface GetSingleItContractTemplateTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAItContractTemplateTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet ItContractTemplateTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractTemplateTypesGetV1(
    requestParameters: GetSingleItContractTemplateTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleItContractTemplateTypesGetV1(
    ...
    let localVarPath = `/odata/ItContractTemplateTypes`;
  ...
  /**
   * Returns the entity with the key from ItContractTemplateTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractTemplateTypesGetV1ById(
    requestParameters: GetSingleItContractTemplateTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItContractTemplateTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleItContractTemplateTypesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/ItContractTemplateTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
