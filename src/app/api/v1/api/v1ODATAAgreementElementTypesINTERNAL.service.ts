...
export class APIV1ODATAAgreementElementTypesINTERNALService {
   ...
   */
  public getSingleAgreementElementTypesGetV1(
    requestParameters: GetSingleAgreementElementTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleAgreementElementTypesGetV1(
    ...
    let localVarPath = `/odata/AgreementElementTypes`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleAgreementElementTypesGetV1ById(
    requestParameters: GetSingleAgreementElementTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleAgreementElementTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleAgreementElementTypesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/AgreementElementTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
