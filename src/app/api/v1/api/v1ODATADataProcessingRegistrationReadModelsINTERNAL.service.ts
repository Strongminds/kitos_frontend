...
export interface GetSingleDataProcessingRegistrationReadModelsGetByUuidRequestParams {
...
export class APIV1ODATADataProcessingRegistrationReadModelsINTERNALService {
  ...
  public getSingleDataProcessingRegistrationReadModelsGetByOrganizationid(
    requestParameters: GetSingleDataProcessingRegistrationReadModelsGetByOrganizationidRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIDataProcessingRegistrationReadModelODataListResponse>;
  public getSingleDataProcessingRegistrationReadModelsGetByOrganizationid(
    requestParameters: GetSingleDataProcessingRegistrationReadModelsGetByOrganizationidRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpResponse<APIDataProcessingRegistrationReadModelODataListResponse>>;
  public getSingleDataProcessingRegistrationReadModelsGetByOrganizationid(
    requestParameters: GetSingleDataProcessingRegistrationReadModelsGetByOrganizationidRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpEvent<APIDataProcessingRegistrationReadModelODataListResponse>>;
  public getSingleDataProcessingRegistrationReadModelsGetByOrganizationid(
    requestParameters: GetSingleDataProcessingRegistrationReadModelsGetByOrganizationidRequestParams,
    observe: any = 'body',
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleDataProcessingRegistrationReadModelsGetByOrganizationid.',
      );
    }
    ...
    return this.httpClient.request<APIDataProcessingRegistrationReadModelODataListResponse>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingRegistrationReadModelsGetByUuid(
    requestParameters: GetSingleDataProcessingRegistrationReadModelsGetByUuidRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIDataProcessingRegistrationReadModelODataListResponse>;
  ...
  public getSingleDataProcessingRegistrationReadModelsGetByUuid(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleDataProcessingRegistrationReadModelsGetByUuid.',
      );
    }
