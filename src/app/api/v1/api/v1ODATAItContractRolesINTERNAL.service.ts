...
export interface GetSingleItContractRolesGetV1RequestParams {
...
export interface GetSingleItContractRolesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAItContractRolesINTERNALService {
  ...
  /**
   * Returns the EntitySet ItContractRoles
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractRolesGetV1(
    requestParameters: GetSingleItContractRolesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleItContractRolesGetV1(
    ...
    let localVarPath = `/odata/ItContractRoles`;
  ...
  /**
   * Returns the entity with the key from ItContractRoles
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractRolesGetV1ById(
    requestParameters: GetSingleItContractRolesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItContractRolesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSingleItContractRolesGetV1ById.');
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/ItContractRoles(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
