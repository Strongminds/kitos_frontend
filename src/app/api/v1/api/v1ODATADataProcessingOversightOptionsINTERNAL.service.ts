...
export class APIV1ODATADataProcessingOversightOptionsINTERNALService {
  ...
  /**
   * Returns the EntitySet DataProcessingOversightOptions
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingOversightOptionsGetV1(
    requestParameters: GetSingleDataProcessingOversightOptionsGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleDataProcessingOversightOptionsGetV1(
    ...
    let localVarPath = `/odata/DataProcessingOversightOptions`;
  ...
  /**
   * Returns the entity with the key from DataProcessingOversightOptions
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingOversightOptionsGetV1ById(
    requestParameters: GetSingleDataProcessingOversightOptionsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleDataProcessingOversightOptionsGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleDataProcessingOversightOptionsGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/DataProcessingOversightOptions(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
