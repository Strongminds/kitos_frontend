...
export class APIV1ItContractINTERNALService {
   ...
   */
  public getSingleItContractGet(
    requestParameters: GetSingleItContractGetRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APINamedEntityDTOIEnumerableApiReturnDTO>;
  public getSingleItContractGet(
    requestParameters: GetSingleItContractGetRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APINamedEntityDTOIEnumerableApiReturnDTO>>;
  public getSingleItContractGet(
    requestParameters: GetSingleItContractGetRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APINamedEntityDTOIEnumerableApiReturnDTO>>;
  public getSingleItContractGet(
    requestParameters: GetSingleItContractGetRequestParams,
    observe: any = 'body',
    ...
    if (orgId !== undefined && orgId !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>orgId, 'orgId');
    }
    ...
    return this.httpClient.request<APINamedEntityDTOIEnumerableApiReturnDTO>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractGetAppliedProcurements(
    requestParameters: GetSingleItContractGetAppliedProcurementsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getSingleItContractGetAppliedProcurements(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleItContractGetAppliedProcurements.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractGetAvailableDataProcessingRegistrations(
    requestParameters: GetSingleItContractGetAvailableDataProcessingRegistrationsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: undefined; context?: HttpContext },
  ): Observable<any>;
  ...
  public getSingleItContractGetAvailableDataProcessingRegistrations(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleItContractGetAvailableDataProcessingRegistrations.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractGetContractOptions(
    requestParameters: GetSingleItContractGetContractOptionsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: undefined; context?: HttpContext },
  ): Observable<any>;
  ...
  public getSingleItContractGetContractOptions(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleItContractGetContractOptions.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractGetSingle(
    requestParameters: GetSingleItContractGetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIItContractDTOApiReturnDTO>;
  public getSingleItContractGetSingle(
    requestParameters: GetSingleItContractGetSingleRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIItContractDTOApiReturnDTO>>;
  public getSingleItContractGetSingle(
    requestParameters: GetSingleItContractGetSingleRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIItContractDTOApiReturnDTO>>;
  public getSingleItContractGetSingle(
    requestParameters: GetSingleItContractGetSingleRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    return this.httpClient.request<APIItContractDTOApiReturnDTO>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractGetValidationStatus(
    requestParameters: GetSingleItContractGetValidationStatusRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: undefined; context?: HttpContext },
  ): Observable<any>;
  ...
  public getSingleItContractGetValidationStatus(
    ...
    if (contractId === null || contractId === undefined) {
      throw new Error(
        'Required parameter contractId was null or undefined when calling getSingleItContractGetValidationStatus.',
      );
    }
