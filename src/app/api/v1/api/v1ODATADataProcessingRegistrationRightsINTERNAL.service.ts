...
export class APIV1ODATADataProcessingRegistrationRightsINTERNALService {
   ...
   */
  public getSingleDataProcessingRegistrationRightsGetByUser(
    requestParameters: GetSingleDataProcessingRegistrationRightsGetByUserRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIDataProcessingRegistrationRightIQueryableODataResponse>;
  public getSingleDataProcessingRegistrationRightsGetByUser(
    requestParameters: GetSingleDataProcessingRegistrationRightsGetByUserRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpResponse<APIDataProcessingRegistrationRightIQueryableODataResponse>>;
  public getSingleDataProcessingRegistrationRightsGetByUser(
    requestParameters: GetSingleDataProcessingRegistrationRightsGetByUserRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpEvent<APIDataProcessingRegistrationRightIQueryableODataResponse>>;
  public getSingleDataProcessingRegistrationRightsGetByUser(
    requestParameters: GetSingleDataProcessingRegistrationRightsGetByUserRequestParams,
    observe: any = 'body',
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling getSingleDataProcessingRegistrationRightsGetByUser.',
      );
    }
    ...
    return this.httpClient.request<APIDataProcessingRegistrationRightIQueryableODataResponse>(
      'get',
