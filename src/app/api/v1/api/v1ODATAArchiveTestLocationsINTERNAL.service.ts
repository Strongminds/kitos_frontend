...
export class APIV1ODATAArchiveTestLocationsINTERNALService {
   ...
   */
  public getSingleArchiveTestLocationsGetV1(
    requestParameters: GetSingleArchiveTestLocationsGetV1RequestParams,
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleArchiveTestLocationsGetV1ById(
    requestParameters: GetSingleArchiveTestLocationsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleArchiveTestLocationsGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleArchiveTestLocationsGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
