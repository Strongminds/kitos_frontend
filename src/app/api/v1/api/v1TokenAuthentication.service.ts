...
export class APIV1TokenAuthenticationService {
   ...
   */
  public postSingleTokenAuthenticationGetToken(
    requestParameters: PostSingleTokenAuthenticationGetTokenRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIGetTokenResponseDTOApiReturnDTO>;
  public postSingleTokenAuthenticationGetToken(
    requestParameters: PostSingleTokenAuthenticationGetTokenRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIGetTokenResponseDTOApiReturnDTO>>;
  public postSingleTokenAuthenticationGetToken(
    requestParameters: PostSingleTokenAuthenticationGetTokenRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIGetTokenResponseDTOApiReturnDTO>>;
  public postSingleTokenAuthenticationGetToken(
    requestParameters: PostSingleTokenAuthenticationGetTokenRequestParams,
    observe: any = 'body',
    ...
    if (loginDto === null || loginDto === undefined) {
      throw new Error(
        'Required parameter loginDto was null or undefined when calling postSingleTokenAuthenticationGetToken.',
      );
    }
    ...
    return this.httpClient.request<APIGetTokenResponseDTOApiReturnDTO>(
      'post',
