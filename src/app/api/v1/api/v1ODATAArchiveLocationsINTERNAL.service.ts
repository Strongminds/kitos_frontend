...
export class APIV1ODATAArchiveLocationsINTERNALService {
  ...
  /**
   * Returns the EntitySet ArchiveLocations
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleArchiveLocationsGetV1(
    requestParameters: GetSingleArchiveLocationsGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleArchiveLocationsGetV1(
    ...
    let localVarPath = `/odata/ArchiveLocations`;
  ...
  /**
   * Returns the entity with the key from ArchiveLocations
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleArchiveLocationsGetV1ById(
    requestParameters: GetSingleArchiveLocationsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleArchiveLocationsGetV1ById(
    ...
    let localVarPath = `/odata/ArchiveLocations(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
