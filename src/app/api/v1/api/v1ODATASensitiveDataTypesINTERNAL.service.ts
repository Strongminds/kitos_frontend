...
export interface GetSingleSensitiveDataTypesGetV1RequestParams {
...
export interface GetSingleSensitiveDataTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATASensitiveDataTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet SensitiveDataTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleSensitiveDataTypesGetV1(
    requestParameters: GetSingleSensitiveDataTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleSensitiveDataTypesGetV1(
    ...
    let localVarPath = `/odata/SensitiveDataTypes`;
  ...
  /**
   * Returns the entity with the key from SensitiveDataTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleSensitiveDataTypesGetV1ById(
    requestParameters: GetSingleSensitiveDataTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleSensitiveDataTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSingleSensitiveDataTypesGetV1ById.');
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/SensitiveDataTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
