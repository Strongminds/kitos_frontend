...
export class APIV1ODATAUsersINTERNALService {
   ...
   */
  public getSingleUsersGetUserByEmail(
    requestParameters: GetSingleUsersGetUserByEmailRequestParams,
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUsersGetUserByEmailAndOrganizationId(
    requestParameters: GetSingleUsersGetUserByEmailAndOrganizationIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleUsersGetUserByEmailAndOrganizationId(
    ...
    if (email === null || email === undefined) {
      throw new Error(
        'Required parameter email was null or undefined when calling getSingleUsersGetUserByEmailAndOrganizationId.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleUsersGetUserByEmailAndOrganizationId.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUsersGetUsersByUuid(
    requestParameters: GetSingleUsersGetUsersByUuidRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleUsersGetUsersByUuid(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleUsersGetUsersByUuid.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUsersGetV1(
    requestParameters: GetSingleUsersGetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUsersGetV1ById(
    requestParameters: GetSingleUsersGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUsersIsEmailAvailableByEmail(
    requestParameters: GetSingleUsersIsEmailAvailableByEmailRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleUsersIsEmailAvailableByEmail(
    ...
    if (email === null || email === undefined) {
      throw new Error(
        'Required parameter email was null or undefined when calling getSingleUsersIsEmailAvailableByEmail.',
      );
    }
