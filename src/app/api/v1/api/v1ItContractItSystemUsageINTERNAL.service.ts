...
export class APIV1ItContractItSystemUsageINTERNALService {
   ...
   */
  public getSingleItContractItSystemUsageGetAccessRights(
    requestParameters: GetSingleItContractItSystemUsageGetAccessRightsRequestParams,
    observe?: 'body',
  ...
  public getSingleItContractItSystemUsageGetAccessRights(
    ...
    if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntitiesAccessRights was null or undefined when calling getSingleItContractItSystemUsageGetAccessRights.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleItContractItSystemUsageGetAccessRights.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractItSystemUsageGetAccessRightsForEntity(
    requestParameters: GetSingleItContractItSystemUsageGetAccessRightsForEntityRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItContractItSystemUsageGetAccessRightsForEntity(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleItContractItSystemUsageGetAccessRightsForEntity.',
      );
    }
    ...
    if (getEntityAccessRights === null || getEntityAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntityAccessRights was null or undefined when calling getSingleItContractItSystemUsageGetAccessRightsForEntity.',
      );
    }
