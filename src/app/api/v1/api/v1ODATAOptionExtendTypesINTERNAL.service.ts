...
export interface GetSingleOptionExtendTypesGetV1RequestParams {
...
export interface GetSingleOptionExtendTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAOptionExtendTypesINTERNALService {
   ...
   */
  public getSingleOptionExtendTypesGetV1(
    requestParameters: GetSingleOptionExtendTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleOptionExtendTypesGetV1(
    ...
    let localVarPath = `/odata/OptionExtendTypes`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleOptionExtendTypesGetV1ById(
    requestParameters: GetSingleOptionExtendTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleOptionExtendTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSingleOptionExtendTypesGetV1ById.');
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/OptionExtendTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
