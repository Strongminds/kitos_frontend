...
export interface GetSingleItContractLocalRoleOptionTypesInternalV2GetAllRequestParams {
...
export class APIV1ItContractLocalRoleOptionTypesInternalV2INTERNALService {
   ...
   */
  public getSingleItContractLocalRoleOptionTypesInternalV2GetAll(
    requestParameters: GetSingleItContractLocalRoleOptionTypesInternalV2GetAllRequestParams,
    observe?: 'body',
  ...
  public getSingleItContractLocalRoleOptionTypesInternalV2GetAll(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleItContractLocalRoleOptionTypesInternalV2GetAll.',
      );
    }
    ...
    let localVarPath = `/api/ItContractLocalRoleOptionTypesInternalV2`;
