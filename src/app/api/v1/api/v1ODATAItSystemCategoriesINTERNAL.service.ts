...
export interface GetSingleItSystemCategoriesGetV1RequestParams {
...
export interface GetSingleItSystemCategoriesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAItSystemCategoriesINTERNALService {
  ...
  /**
   * Returns the EntitySet ItSystemCategories
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemCategoriesGetV1(
    requestParameters: GetSingleItSystemCategoriesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleItSystemCategoriesGetV1(
    ...
    let localVarPath = `/odata/ItSystemCategories`;
  ...
  /**
   * Returns the entity with the key from ItSystemCategories
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemCategoriesGetV1ById(
    requestParameters: GetSingleItSystemCategoriesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItSystemCategoriesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSingleItSystemCategoriesGetV1ById.');
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/ItSystemCategories(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
