...
export interface GetSingleOrganizationUnitLocalRoleOptionTypesInternalV2GetAllRequestParams {
...
export class APIV1OrganizationUnitLocalRoleOptionTypesInternalV2INTERNALService {
   ...
   */
  public getSingleOrganizationUnitLocalRoleOptionTypesInternalV2GetAll(
    requestParameters: GetSingleOrganizationUnitLocalRoleOptionTypesInternalV2GetAllRequestParams,
    observe?: 'body',
  ...
  public getSingleOrganizationUnitLocalRoleOptionTypesInternalV2GetAll(
    ...
    if (organizationUuid === null || organizationUuid === undefined) {
      throw new Error(
        'Required parameter organizationUuid was null or undefined when calling getSingleOrganizationUnitLocalRoleOptionTypesInternalV2GetAll.',
      );
    }
    ...
    let localVarPath = `/api/OrganizationUnitLocalRoleOptionTypesInternalV2`;
