...
export interface GetSingleItSystemUsageRightsGetAccessRightsRequestParams {
...
export class APIV1ItSystemUsageRightsINTERNALService {
   ...
   */
  public getSingleItSystemUsageRightsGetAccessRights(
    requestParameters: GetSingleItSystemUsageRightsGetAccessRightsRequestParams,
    observe?: 'body',
  ...
  public getSingleItSystemUsageRightsGetAccessRights(
    ...
    if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntitiesAccessRights was null or undefined when calling getSingleItSystemUsageRightsGetAccessRights.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleItSystemUsageRightsGetAccessRights.',
      );
    }
    ...
    let localVarPath = `/api/ItSystemUsageRights`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageRightsGetRights(
    requestParameters: GetSingleItSystemUsageRightsGetRightsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItSystemUsageRightsGetRights(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleItSystemUsageRightsGetRights.',
      );
    }
    ...
    let localVarPath = `/api/ItSystemUsageRights/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })}`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
