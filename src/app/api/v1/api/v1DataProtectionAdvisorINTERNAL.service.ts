...
export class APIV1DataProtectionAdvisorINTERNALService {
   ...
   */
  public getSingleDataProtectionAdvisorGetAll(
    requestParameters: GetSingleDataProtectionAdvisorGetAllRequestParams,
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProtectionAdvisorGetSingle(
    requestParameters: GetSingleDataProtectionAdvisorGetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIDataProtectionAdvisorDTOApiReturnDTO>;
  public getSingleDataProtectionAdvisorGetSingle(
    requestParameters: GetSingleDataProtectionAdvisorGetSingleRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIDataProtectionAdvisorDTOApiReturnDTO>>;
  public getSingleDataProtectionAdvisorGetSingle(
    requestParameters: GetSingleDataProtectionAdvisorGetSingleRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIDataProtectionAdvisorDTOApiReturnDTO>>;
  public getSingleDataProtectionAdvisorGetSingle(
    requestParameters: GetSingleDataProtectionAdvisorGetSingleRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleDataProtectionAdvisorGetSingle.',
      );
    }
    ...
    return this.httpClient.request<APIDataProtectionAdvisorDTOApiReturnDTO>(
      'get',
