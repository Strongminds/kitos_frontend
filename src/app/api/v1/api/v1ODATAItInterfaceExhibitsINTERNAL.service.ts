...
export class APIV1ODATAItInterfaceExhibitsINTERNALService {
  ...
  /**
   * Returns the EntitySet ItInterfaceExhibits
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItInterfaceExhibitsGetV1(
    requestParameters: GetSingleItInterfaceExhibitsGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleItInterfaceExhibitsGetV1(
    ...
    let localVarPath = `/odata/ItInterfaceExhibits`;
  ...
  /**
   * Returns the entity with the key from ItInterfaceExhibits
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItInterfaceExhibitsGetV1ById(
    requestParameters: GetSingleItInterfaceExhibitsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItInterfaceExhibitsGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleItInterfaceExhibitsGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/ItInterfaceExhibits(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
