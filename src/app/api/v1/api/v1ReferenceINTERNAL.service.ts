...
export interface GetSingleReferenceGetAccessRightsRequestParams {
...
export class APIV1ReferenceINTERNALService {
   ...
   */
  public getSingleReferenceGetAccessRights(
    requestParameters: GetSingleReferenceGetAccessRightsRequestParams,
    observe?: 'body',
  ...
  public getSingleReferenceGetAccessRights(
    ...
    if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntitiesAccessRights was null or undefined when calling getSingleReferenceGetAccessRights.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleReferenceGetAccessRights.',
      );
    }
    ...
    let localVarPath = `/api/Reference`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleReferenceGetSingle(
    requestParameters: GetSingleReferenceGetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleReferenceGetSingle(
    ...
    let localVarPath = `/api/Reference/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })}`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
