...
export class APIV1ODATADataProcessingBasisForTransferOptionsINTERNALService {
  ...
  /**
   * Returns the EntitySet DataProcessingBasisForTransferOptions
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingBasisForTransferOptionsGetV1(
    requestParameters: GetSingleDataProcessingBasisForTransferOptionsGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleDataProcessingBasisForTransferOptionsGetV1(
    ...
    let localVarPath = `/odata/DataProcessingBasisForTransferOptions`;
  ...
  /**
   * Returns the entity with the key from DataProcessingBasisForTransferOptions
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingBasisForTransferOptionsGetV1ById(
    requestParameters: GetSingleDataProcessingBasisForTransferOptionsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleDataProcessingBasisForTransferOptionsGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleDataProcessingBasisForTransferOptionsGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/DataProcessingBasisForTransferOptions(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
