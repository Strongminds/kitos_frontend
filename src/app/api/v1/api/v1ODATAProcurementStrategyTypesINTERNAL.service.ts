...
export interface GetSingleProcurementStrategyTypesGetV1RequestParams {
...
export interface GetSingleProcurementStrategyTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAProcurementStrategyTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet ProcurementStrategyTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleProcurementStrategyTypesGetV1(
    requestParameters: GetSingleProcurementStrategyTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleProcurementStrategyTypesGetV1(
    ...
    let localVarPath = `/odata/ProcurementStrategyTypes`;
  ...
  /**
   * Returns the entity with the key from ProcurementStrategyTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleProcurementStrategyTypesGetV1ById(
    requestParameters: GetSingleProcurementStrategyTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleProcurementStrategyTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleProcurementStrategyTypesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/ProcurementStrategyTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
