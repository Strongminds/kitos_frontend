...
export class APIV1ODATAArchivePeriodsINTERNALService {
  ...
  public getSingleArchivePeriodsGetArchivePeriodsForItSystemUsageByOrganizationidAndSystemusageid(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleArchivePeriodsGetArchivePeriodsForItSystemUsageByOrganizationidAndSystemusageid.',
      );
    }
    const systemUsageId = requestParameters.systemUsageId;
    if (systemUsageId === null || systemUsageId === undefined) {
      throw new Error(
        'Required parameter systemUsageId was null or undefined when calling getSingleArchivePeriodsGetArchivePeriodsForItSystemUsageByOrganizationidAndSystemusageid.',
      );
    }
    ...
    let localVarPath = `/odata/Organizations(${this.configuration.encodeParam({ name: 'organizationId', value: organizationId, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})/ItSystemUsages(${this.configuration.encodeParam({ name: 'systemUsageId', value: systemUsageId, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})/ArchivePeriods`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleArchivePeriodsGetV1(
    requestParameters: GetSingleArchivePeriodsGetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleArchivePeriodsGetV1(
    ...
    let localVarPath = `/odata/ArchivePeriods`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
  ...
  /**
   * Returns the entity with the key from ArchivePeriods
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleArchivePeriodsGetV1ById(
    requestParameters: GetSingleArchivePeriodsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleArchivePeriodsGetV1ById(
    ...
    let localVarPath = `/odata/ArchivePeriods(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
