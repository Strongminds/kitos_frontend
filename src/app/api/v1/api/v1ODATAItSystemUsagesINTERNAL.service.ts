...
export class APIV1ODATAItSystemUsagesINTERNALService {
   ...
   */
  public getSingleItSystemUsagesGetItSystemsByOrgkey(
    requestParameters: GetSingleItSystemUsagesGetItSystemsByOrgkeyRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIItSystemUsageIEnumerableODataResponse>;
  public getSingleItSystemUsagesGetItSystemsByOrgkey(
    requestParameters: GetSingleItSystemUsagesGetItSystemsByOrgkeyRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpResponse<APIItSystemUsageIEnumerableODataResponse>>;
  public getSingleItSystemUsagesGetItSystemsByOrgkey(
    requestParameters: GetSingleItSystemUsagesGetItSystemsByOrgkeyRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpEvent<APIItSystemUsageIEnumerableODataResponse>>;
  public getSingleItSystemUsagesGetItSystemsByOrgkey(
    requestParameters: GetSingleItSystemUsagesGetItSystemsByOrgkeyRequestParams,
    observe: any = 'body',
    ...
    if (orgKey === null || orgKey === undefined) {
      throw new Error(
        'Required parameter orgKey was null or undefined when calling getSingleItSystemUsagesGetItSystemsByOrgkey.',
      );
    }
    ...
    return this.httpClient.request<APIItSystemUsageIEnumerableODataResponse>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsagesGetV1(
    requestParameters: GetSingleItSystemUsagesGetV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsagesGetV1ById(
    requestParameters: GetSingleItSystemUsagesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
