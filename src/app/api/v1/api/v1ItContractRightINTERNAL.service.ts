...
export interface GetSingleItContractRightGetAccessRightsRequestParams {
...
export class APIV1ItContractRightINTERNALService {
   ...
   */
  public getSingleItContractRightGetAccessRights(
    requestParameters: GetSingleItContractRightGetAccessRightsRequestParams,
    observe?: 'body',
  ...
  public getSingleItContractRightGetAccessRights(
    ...
    if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntitiesAccessRights was null or undefined when calling getSingleItContractRightGetAccessRights.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleItContractRightGetAccessRights.',
      );
    }
    ...
    let localVarPath = `/api/ItContractRight`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractRightGetRights(
    requestParameters: GetSingleItContractRightGetRightsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItContractRightGetRights(
    ...
    let localVarPath = `/api/ItContractRight/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })}`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      withCredentials: this.configuration.withCredentials,
