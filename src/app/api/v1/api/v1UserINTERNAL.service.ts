...
export interface GetSingleUserGetSingleRequestParams {
  id: number;
}
...
export class APIV1UserINTERNALService {
   ...
   */
  public getSingleUserGetAll(
    requestParameters: GetSingleUserGetAllRequestParams,
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUserGetSingle(
    requestParameters: GetSingleUserGetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleUserGetSingle(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSingleUserGetSingle.');
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUserGetUsersWithCrossAccess(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUserGetUsersWithRightsholderAccess(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleUserSearchUsers(
    requestParameters: GetSingleUserSearchUsersRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
