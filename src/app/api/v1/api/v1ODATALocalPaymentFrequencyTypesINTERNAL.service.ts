...
export class APIV1ODATALocalPaymentFrequencyTypesINTERNALService {
   ...
   */
  public getSingleLocalPaymentFrequencyTypesGetByOrganizationId(
    requestParameters: GetSingleLocalPaymentFrequencyTypesGetByOrganizationIdRequestParams,
    observe?: 'body',
  ...
  public getSingleLocalPaymentFrequencyTypesGetByOrganizationId(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleLocalPaymentFrequencyTypesGetByOrganizationId.',
      );
    }
    ...
    let localVarPath = `/odata/LocalPaymentFrequencyTypes`;
