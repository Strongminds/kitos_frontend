...
export interface GetSingleDataProcessingRegistrationRolesGetV1RequestParams {
...
export interface GetSingleDataProcessingRegistrationRolesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATADataProcessingRegistrationRolesINTERNALService {
   ...
   */
  public getSingleDataProcessingRegistrationRolesGetV1(
    requestParameters: GetSingleDataProcessingRegistrationRolesGetV1RequestParams,
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingRegistrationRolesGetV1ById(
    requestParameters: GetSingleDataProcessingRegistrationRolesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleDataProcessingRegistrationRolesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleDataProcessingRegistrationRolesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
