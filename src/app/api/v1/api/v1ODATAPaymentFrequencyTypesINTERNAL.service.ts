...
export interface GetSinglePaymentFrequencyTypesGetV1RequestParams {
...
export interface GetSinglePaymentFrequencyTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAPaymentFrequencyTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet PaymentFrequencyTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSinglePaymentFrequencyTypesGetV1(
    requestParameters: GetSinglePaymentFrequencyTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSinglePaymentFrequencyTypesGetV1(
    ...
    let localVarPath = `/odata/PaymentFrequencyTypes`;
  ...
  /**
   * Returns the entity with the key from PaymentFrequencyTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSinglePaymentFrequencyTypesGetV1ById(
    requestParameters: GetSinglePaymentFrequencyTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSinglePaymentFrequencyTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSinglePaymentFrequencyTypesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/PaymentFrequencyTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
