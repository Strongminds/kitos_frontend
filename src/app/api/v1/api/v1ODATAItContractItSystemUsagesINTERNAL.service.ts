...
export interface GetSingleItContractItSystemUsagesGetRequestParams {
...
export class APIV1ODATAItContractItSystemUsagesINTERNALService {
  ...
  /**
   * Returns the EntitySet ItContractItSystemUsages
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractItSystemUsagesGet(
    requestParameters: GetSingleItContractItSystemUsagesGetRequestParams,
    observe?: 'body',
  ...
  public getSingleItContractItSystemUsagesGet(
    ...
    let localVarPath = `/odata/ItContractItSystemUsages`;
