...
export class APIV1DataResponsibleINTERNALService {
   ...
   */
  public getSingleDataResponsibleGetAll(
    requestParameters: GetSingleDataResponsibleGetAllRequestParams,
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataResponsibleGetSingle(
    requestParameters: GetSingleDataResponsibleGetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIDataResponsibleDTOApiReturnDTO>;
  public getSingleDataResponsibleGetSingle(
    requestParameters: GetSingleDataResponsibleGetSingleRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIDataResponsibleDTOApiReturnDTO>>;
  public getSingleDataResponsibleGetSingle(
    requestParameters: GetSingleDataResponsibleGetSingleRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIDataResponsibleDTOApiReturnDTO>>;
  public getSingleDataResponsibleGetSingle(
    requestParameters: GetSingleDataResponsibleGetSingleRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    return this.httpClient.request<APIDataResponsibleDTOApiReturnDTO>(
      'get',
