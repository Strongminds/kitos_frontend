...
export class APIV1ODATALocalCriticalityTypesINTERNALService {
   ...
   */
  public getSingleLocalCriticalityTypesGetByOrganizationId(
    requestParameters: GetSingleLocalCriticalityTypesGetByOrganizationIdRequestParams,
    observe?: 'body',
  ...
  public getSingleLocalCriticalityTypesGetByOrganizationId(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleLocalCriticalityTypesGetByOrganizationId.',
      );
    }
    ...
    let localVarPath = `/odata/LocalCriticalityTypes`;
