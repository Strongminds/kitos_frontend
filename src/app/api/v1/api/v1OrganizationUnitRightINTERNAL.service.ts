...
export interface GetSingleOrganizationUnitRightGetRightsV1RequestParams {
  /** Id of the unit */
  id: number;
  paged: boolean;
  skip?: number;
...
export class APIV1OrganizationUnitRightINTERNALService {
   ...
   */
  public getSingleOrganizationUnitRightGetAccessRights(
    requestParameters: GetSingleOrganizationUnitRightGetAccessRightsRequestParams,
    observe?: 'body',
  ...
  public getSingleOrganizationUnitRightGetAccessRights(
    ...
    if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntitiesAccessRights was null or undefined when calling getSingleOrganizationUnitRightGetAccessRights.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleOrganizationUnitRightGetAccessRights.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleOrganizationUnitRightGetRightsV1(
    requestParameters: GetSingleOrganizationUnitRightGetRightsV1RequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleOrganizationUnitRightGetRightsV1(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleOrganizationUnitRightGetRightsV1.',
      );
    }
    const paged = requestParameters.paged;
    if (paged === null || paged === undefined) {
      throw new Error(
        'Required parameter paged was null or undefined when calling getSingleOrganizationUnitRightGetRightsV1.',
      );
    }
