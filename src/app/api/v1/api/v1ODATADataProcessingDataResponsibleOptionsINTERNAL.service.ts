...
export interface GetSingleDataProcessingDataResponsibleOptionsGetV1RequestParams {
...
export interface GetSingleDataProcessingDataResponsibleOptionsGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATADataProcessingDataResponsibleOptionsINTERNALService {
  ...
  /**
   * Returns the EntitySet DataProcessingDataResponsibleOptions
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingDataResponsibleOptionsGetV1(
    requestParameters: GetSingleDataProcessingDataResponsibleOptionsGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleDataProcessingDataResponsibleOptionsGetV1(
    ...
    let localVarPath = `/odata/DataProcessingDataResponsibleOptions`;
  ...
  /**
   * Returns the entity with the key from DataProcessingDataResponsibleOptions
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingDataResponsibleOptionsGetV1ById(
    requestParameters: GetSingleDataProcessingDataResponsibleOptionsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleDataProcessingDataResponsibleOptionsGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleDataProcessingDataResponsibleOptionsGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/DataProcessingDataResponsibleOptions(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
