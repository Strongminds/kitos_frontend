...
export interface GetSingleTerminationDeadlineTypesGetV1RequestParams {
...
export interface GetSingleTerminationDeadlineTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATATerminationDeadlineTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet TerminationDeadlineTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleTerminationDeadlineTypesGetV1(
    requestParameters: GetSingleTerminationDeadlineTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleTerminationDeadlineTypesGetV1(
    ...
    let localVarPath = `/odata/TerminationDeadlineTypes`;
  ...
  /**
   * Returns the entity with the key from TerminationDeadlineTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleTerminationDeadlineTypesGetV1ById(
    requestParameters: GetSingleTerminationDeadlineTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleTerminationDeadlineTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleTerminationDeadlineTypesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/TerminationDeadlineTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
