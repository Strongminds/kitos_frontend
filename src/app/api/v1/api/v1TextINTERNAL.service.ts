...
export interface GetSingleTextGetAccessRightsForEntityRequestParams {
  id: number;
...
export class APIV1TextINTERNALService {
   ...
   */
  public getSingleTextGetAccessRightsForEntity(
    requestParameters: GetSingleTextGetAccessRightsForEntityRequestParams,
    observe?: 'body',
  ...
  public getSingleTextGetAccessRightsForEntity(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleTextGetAccessRightsForEntity.',
      );
    }
    ...
    if (getEntityAccessRights === null || getEntityAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntityAccessRights was null or undefined when calling getSingleTextGetAccessRightsForEntity.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleTextGetAll(
    requestParameters: GetSingleTextGetAllRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APITextDTOIEnumerableApiReturnDTO>;
  public getSingleTextGetAll(
    requestParameters: GetSingleTextGetAllRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APITextDTOIEnumerableApiReturnDTO>>;
  public getSingleTextGetAll(
    requestParameters: GetSingleTextGetAllRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APITextDTOIEnumerableApiReturnDTO>>;
  public getSingleTextGetAll(
    requestParameters: GetSingleTextGetAllRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    return this.httpClient.request<APITextDTOIEnumerableApiReturnDTO>(
      'get',
