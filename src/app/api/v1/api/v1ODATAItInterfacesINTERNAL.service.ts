...
export class APIV1ODATAItInterfacesINTERNALService {
   ...
   */
  public getSingleItInterfacesGet(
    requestParameters: GetSingleItInterfacesGetRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIItInterfaceODataResponse>;
  public getSingleItInterfacesGet(
    requestParameters: GetSingleItInterfacesGetRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpResponse<APIItInterfaceODataResponse>>;
  public getSingleItInterfacesGet(
    requestParameters: GetSingleItInterfacesGetRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpEvent<APIItInterfaceODataResponse>>;
  public getSingleItInterfacesGet(
    requestParameters: GetSingleItInterfacesGetRequestParams,
    observe: any = 'body',
    ...
    return this.httpClient.request<APIItInterfaceODataResponse>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItInterfacesGetItInterfacesByKey(
    requestParameters: GetSingleItInterfacesGetItInterfacesByKeyRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<APIItInterfaceIQueryableODataResponse>;
  public getSingleItInterfacesGetItInterfacesByKey(
    requestParameters: GetSingleItInterfacesGetItInterfacesByKeyRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpResponse<APIItInterfaceIQueryableODataResponse>>;
  public getSingleItInterfacesGetItInterfacesByKey(
    requestParameters: GetSingleItInterfacesGetItInterfacesByKeyRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*'; context?: HttpContext },
  ): Observable<HttpEvent<APIItInterfaceIQueryableODataResponse>>;
  public getSingleItInterfacesGetItInterfacesByKey(
    requestParameters: GetSingleItInterfacesGetItInterfacesByKeyRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (key === null || key === undefined) {
      throw new Error(
        'Required parameter key was null or undefined when calling getSingleItInterfacesGetItInterfacesByKey.',
      );
    }
    const $expand = requestParameters.$expand;
    const $filter = requestParameters.$filter;
    ...
    return this.httpClient.request<APIItInterfaceIQueryableODataResponse>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItInterfacesGetV1ById(
    requestParameters: GetSingleItInterfacesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
