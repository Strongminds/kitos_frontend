...
export interface GetSingleItContractTypesGetV1RequestParams {
...
export interface GetSingleItContractTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAItContractTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet ItContractTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractTypesGetV1(
    requestParameters: GetSingleItContractTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleItContractTypesGetV1(
    ...
    let localVarPath = `/odata/ItContractTypes`;
  ...
  /**
   * Returns the entity with the key from ItContractTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItContractTypesGetV1ById(
    requestParameters: GetSingleItContractTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItContractTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getSingleItContractTypesGetV1ById.');
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/ItContractTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
