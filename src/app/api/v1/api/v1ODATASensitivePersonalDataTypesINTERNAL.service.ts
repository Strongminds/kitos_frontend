...
export class APIV1ODATASensitivePersonalDataTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet SensitivePersonalDataTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleSensitivePersonalDataTypesGetV1(
    requestParameters: GetSingleSensitivePersonalDataTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleSensitivePersonalDataTypesGetV1(
    ...
    let localVarPath = `/odata/SensitivePersonalDataTypes`;
  ...
  /**
   * Returns the entity with the key from SensitivePersonalDataTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleSensitivePersonalDataTypesGetV1ById(
    requestParameters: GetSingleSensitivePersonalDataTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleSensitivePersonalDataTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleSensitivePersonalDataTypesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/SensitivePersonalDataTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
