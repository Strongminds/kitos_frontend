...
export interface GetSingleDataProcessingCountryOptionsGetV1RequestParams {
...
export interface GetSingleDataProcessingCountryOptionsGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATADataProcessingCountryOptionsINTERNALService {
  ...
  /**
   * Returns the EntitySet DataProcessingCountryOptions
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingCountryOptionsGetV1(
    requestParameters: GetSingleDataProcessingCountryOptionsGetV1RequestParams,
    observe?: 'body',
  ...
  public getSingleDataProcessingCountryOptionsGetV1(
    ...
    let localVarPath = `/odata/DataProcessingCountryOptions`;
  ...
  /**
   * Returns the entity with the key from DataProcessingCountryOptions
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleDataProcessingCountryOptionsGetV1ById(
    requestParameters: GetSingleDataProcessingCountryOptionsGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleDataProcessingCountryOptionsGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleDataProcessingCountryOptionsGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/DataProcessingCountryOptions(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
