...
export interface GetSingleGlobalAdminGetAccessRightsForEntityRequestParams {
  id: number;
...
export class APIV1GlobalAdminINTERNALService {
   ...
   */
  public getSingleGlobalAdminGet(
    observe?: 'body',
  ...
  public getSingleGlobalAdminGet(
    ...
    let localVarPath = `/api/GlobalAdmin`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleGlobalAdminGetAccessRightsForEntity(
    requestParameters: GetSingleGlobalAdminGetAccessRightsForEntityRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleGlobalAdminGetAccessRightsForEntity(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleGlobalAdminGetAccessRightsForEntity.',
      );
    }
    ...
    if (getEntityAccessRights === null || getEntityAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntityAccessRights was null or undefined when calling getSingleGlobalAdminGetAccessRightsForEntity.',
      );
    }
    ...
    let localVarPath = `/api/GlobalAdmin/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })}`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
