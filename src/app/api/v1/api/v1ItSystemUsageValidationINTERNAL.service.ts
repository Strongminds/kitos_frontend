...
export class APIV1ItSystemUsageValidationINTERNALService {
   ...
   */
  public getSingleItSystemUsageValidationGetAccessRights(
    requestParameters: GetSingleItSystemUsageValidationGetAccessRightsRequestParams,
    observe?: 'body',
  ...
  public getSingleItSystemUsageValidationGetAccessRights(
    ...
    if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntitiesAccessRights was null or undefined when calling getSingleItSystemUsageValidationGetAccessRights.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleItSystemUsageValidationGetAccessRights.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageValidationGetAccessRightsForEntity(
    requestParameters: GetSingleItSystemUsageValidationGetAccessRightsForEntityRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleItSystemUsageValidationGetAccessRightsForEntity(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleItSystemUsageValidationGetAccessRightsForEntity.',
      );
    }
    ...
    if (getEntityAccessRights === null || getEntityAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntityAccessRights was null or undefined when calling getSingleItSystemUsageValidationGetAccessRightsForEntity.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleItSystemUsageValidationGetValidationStatus(
    requestParameters: GetSingleItSystemUsageValidationGetValidationStatusRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public getSingleItSystemUsageValidationGetValidationStatus(
    ...
    if (usageId === null || usageId === undefined) {
      throw new Error(
        'Required parameter usageId was null or undefined when calling getSingleItSystemUsageValidationGetValidationStatus.',
      );
    }
