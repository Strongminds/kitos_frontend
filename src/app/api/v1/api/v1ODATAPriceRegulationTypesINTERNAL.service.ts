...
export interface GetSinglePriceRegulationTypesGetV1RequestParams {
...
export interface GetSinglePriceRegulationTypesGetV1ByIdRequestParams {
  /** key: Id */
  id: number;
  /** Expands related entities inline. */
  $expand?: string;
...
export class APIV1ODATAPriceRegulationTypesINTERNALService {
  ...
  /**
   * Returns the EntitySet PriceRegulationTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSinglePriceRegulationTypesGetV1(
    requestParameters: GetSinglePriceRegulationTypesGetV1RequestParams,
    observe?: 'body',
  ...
  public getSinglePriceRegulationTypesGetV1(
    ...
    let localVarPath = `/odata/PriceRegulationTypes`;
  ...
  /**
   * Returns the entity with the key from PriceRegulationTypes
   * @param requestParameters
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public getSinglePriceRegulationTypesGetV1ById(
    requestParameters: GetSinglePriceRegulationTypesGetV1ByIdRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSinglePriceRegulationTypesGetV1ById(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSinglePriceRegulationTypesGetV1ById.',
      );
    }
    const $expand = requestParameters.$expand;
    const $select = requestParameters.$select;
    ...
    let localVarPath = `/odata/PriceRegulationTypes(${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
