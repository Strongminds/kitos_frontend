...
export class APIV1AuthorizeINTERNALService {
   ...
   */
  public getSingleAuthorizeGetAntiForgeryToken(
    observe?: 'body',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleAuthorizeGetLogin(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIUserDTOApiReturnDTO>;
  public getSingleAuthorizeGetLogin(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIUserDTOApiReturnDTO>>;
  public getSingleAuthorizeGetLogin(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIUserDTOApiReturnDTO>>;
  public getSingleAuthorizeGetLogin(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleAuthorizeGetOrganization(
    requestParameters: GetSingleAuthorizeGetOrganizationRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIOrganizationAndDefaultUnitDTOApiReturnDTO>;
  public getSingleAuthorizeGetOrganization(
    requestParameters: GetSingleAuthorizeGetOrganizationRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIOrganizationAndDefaultUnitDTOApiReturnDTO>>;
  public getSingleAuthorizeGetOrganization(
    requestParameters: GetSingleAuthorizeGetOrganizationRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIOrganizationAndDefaultUnitDTOApiReturnDTO>>;
  public getSingleAuthorizeGetOrganization(
    requestParameters: GetSingleAuthorizeGetOrganizationRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    return this.httpClient.request<APIOrganizationAndDefaultUnitDTOApiReturnDTO>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleAuthorizeGetOrganizations(
    requestParameters: GetSingleAuthorizeGetOrganizationsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIOrganizationSimpleDTOIEnumerableApiReturnDTO>;
  public getSingleAuthorizeGetOrganizations(
    requestParameters: GetSingleAuthorizeGetOrganizationsRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIOrganizationSimpleDTOIEnumerableApiReturnDTO>>;
  public getSingleAuthorizeGetOrganizations(
    requestParameters: GetSingleAuthorizeGetOrganizationsRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIOrganizationSimpleDTOIEnumerableApiReturnDTO>>;
  public getSingleAuthorizeGetOrganizations(
    requestParameters: GetSingleAuthorizeGetOrganizationsRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (orderByAsc !== undefined && orderByAsc !== null) {
      localVarQueryParameters = this.addToHttpParams(localVarQueryParameters, <any>orderByAsc, 'orderByAsc');
    }
    ...
    return this.httpClient.request<APIOrganizationSimpleDTOIEnumerableApiReturnDTO>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleAuthorizeGetUserOrganizations(
    requestParameters: GetSingleAuthorizeGetUserOrganizationsRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIOrganizationSimpleDTOIEnumerableApiReturnDTO>;
  ...
  public getSingleAuthorizeGetUserOrganizations(
    ...
    if (userId === null || userId === undefined) {
      throw new Error(
        'Required parameter userId was null or undefined when calling getSingleAuthorizeGetUserOrganizations.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleAuthorizePostLogin(
    requestParameters: PostSingleAuthorizePostLoginRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public postSingleAuthorizePostLogin(
    ...
    const consumes: string[] = ['application/json', 'text/json', 'application/x-www-form-urlencoded'];
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public postSingleAuthorizePostLogout(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
