...
export interface GetSingleLocalDataProcessingRegistrationRolesGetByOrganizationIdRequestParams {
...
export class APIV1ODATALocalDataProcessingRegistrationRolesINTERNALService {
   ...
   */
  public getSingleLocalDataProcessingRegistrationRolesGetByOrganizationId(
    requestParameters: GetSingleLocalDataProcessingRegistrationRolesGetByOrganizationIdRequestParams,
    observe?: 'body',
  ...
  public getSingleLocalDataProcessingRegistrationRolesGetByOrganizationId(
    ...
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleLocalDataProcessingRegistrationRolesGetByOrganizationId.',
      );
    }
    ...
    let localVarPath = `/odata/LocalDataProcessingRegistrationRoles`;
