...
export class APIV1EconomyStreamINTERNALService {
  ...
  public getSingleEconomyStreamGetExternEconomyStreamForContract(
    requestParameters: GetSingleEconomyStreamGetExternEconomyStreamForContractRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<APIEconomyStreamDTOIEnumerableApiReturnDTO>;
  public getSingleEconomyStreamGetExternEconomyStreamForContract(
    requestParameters: GetSingleEconomyStreamGetExternEconomyStreamForContractRequestParams,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpResponse<APIEconomyStreamDTOIEnumerableApiReturnDTO>>;
  public getSingleEconomyStreamGetExternEconomyStreamForContract(
    requestParameters: GetSingleEconomyStreamGetExternEconomyStreamForContractRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<HttpEvent<APIEconomyStreamDTOIEnumerableApiReturnDTO>>;
  public getSingleEconomyStreamGetExternEconomyStreamForContract(
    requestParameters: GetSingleEconomyStreamGetExternEconomyStreamForContractRequestParams,
    observe: any = 'body',
    ...
    if (externPaymentForContractWithId === null || externPaymentForContractWithId === undefined) {
      throw new Error(
        'Required parameter externPaymentForContractWithId was null or undefined when calling getSingleEconomyStreamGetExternEconomyStreamForContract.',
      );
    }
    ...
    if (externPaymentForContractWithId !== undefined && externPaymentForContractWithId !== null) {
      localVarQueryParameters = this.addToHttpParams(
        ...
        <any>externPaymentForContractWithId,
        'externPaymentForContractWithId',
      );
    }
    ...
    return this.httpClient.request<APIEconomyStreamDTOIEnumerableApiReturnDTO>(
      'get',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleEconomyStreamGetSingle(
    requestParameters: GetSingleEconomyStreamGetSingleRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
