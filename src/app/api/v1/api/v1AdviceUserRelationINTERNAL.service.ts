...
export interface GetSingleAdviceUserRelationGetAccessRightsRequestParams {
...
export class APIV1AdviceUserRelationINTERNALService {
   ...
   */
  public getSingleAdviceUserRelationGetAccessRights(
    requestParameters: GetSingleAdviceUserRelationGetAccessRightsRequestParams,
    observe?: 'body',
  ...
  public getSingleAdviceUserRelationGetAccessRights(
    ...
    if (getEntitiesAccessRights === null || getEntitiesAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntitiesAccessRights was null or undefined when calling getSingleAdviceUserRelationGetAccessRights.',
      );
    }
    const organizationId = requestParameters.organizationId;
    if (organizationId === null || organizationId === undefined) {
      throw new Error(
        'Required parameter organizationId was null or undefined when calling getSingleAdviceUserRelationGetAccessRights.',
      );
    }
    ...
    let localVarPath = `/api/AdviceUserRelation`;
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getSingleAdviceUserRelationGetAccessRightsForEntity(
    requestParameters: GetSingleAdviceUserRelationGetAccessRightsForEntityRequestParams,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/json'; context?: HttpContext },
  ): Observable<object>;
  ...
  public getSingleAdviceUserRelationGetAccessRightsForEntity(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleAdviceUserRelationGetAccessRightsForEntity.',
      );
    }
    ...
    if (getEntityAccessRights === null || getEntityAccessRights === undefined) {
      throw new Error(
        'Required parameter getEntityAccessRights was null or undefined when calling getSingleAdviceUserRelationGetAccessRightsForEntity.',
      );
    }
    ...
    let localVarPath = `/api/AdviceUserRelation/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })}`;
    return this.httpClient.request<object>('get', `${this.configuration.basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
      responseType: <any>responseType_,
