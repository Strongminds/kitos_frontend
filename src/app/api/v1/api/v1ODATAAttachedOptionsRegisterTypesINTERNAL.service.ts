...
export class APIV1ODATAAttachedOptionsRegisterTypesINTERNALService {
   ...
   */
  public getSingleAttachedOptionsRegisterTypesGetRegisterTypesByObjectID(
    requestParameters: GetSingleAttachedOptionsRegisterTypesGetRegisterTypesByObjectIDRequestParams,
    observe?: 'body',
  ...
  public getSingleAttachedOptionsRegisterTypesGetRegisterTypesByObjectID(
    ...
    if (id === null || id === undefined) {
      throw new Error(
        'Required parameter id was null or undefined when calling getSingleAttachedOptionsRegisterTypesGetRegisterTypesByObjectID.',
      );
    }
    ...
    let localVarPath = `/odata/GetRegisterTypesByObjectID(id=${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'number', dataFormat: 'int32' })})`;
