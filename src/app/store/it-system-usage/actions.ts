...
export const ITSystemUsageActions = createActionGroup({
  ...
  events: {
    'Get IT System Usages': (odataString: string, responsibleUnitUuid: string | undefined, gridState: GridState | undefined = undefined) => ({ odataString, responsibleUnitUuid, gridState }),
