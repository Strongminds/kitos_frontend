...
export const DEFAULT_UNCLICKABLE_GRID_COLUMN_STYLES = ['link', 'page-link', 'title-link', 'usages', 'action-buttons'];
...
export const ARCHIVE_PRESERVE_DATA_DISCARD_OPTION_TEXT = $localize`Data bevares, udvalgte/alle kan dokumenter kasseres`;
