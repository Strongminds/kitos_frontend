...
describe('global-admin-organizations', () => {
  it('Tests', () => {
    ...
    testRunner.runTestWithSetup('Can edit organization', () => {
    ...
    testRunner.runTestWithSetup('Can create organization', () => {
    ...
    testRunner.runTestWithSetup('Can delete organization with no conflicts', () => {
    ...
    testRunner.runTestWithSetup('Can not delete organization with conflicts, if checkbox is not checked', () => {
      cy.intercept('GET', 'api/v2/internal/organizations/*/conflicts', {
        statusCode: 200,
    ...
    testRunner.runTestWithSetup('Can delete organization with conflicts, if checkbox is checked', () => {
      cy.intercept('GET', 'api/v2/internal/organizations/*/conflicts', {
        statusCode: 200,
        fixture: './global-admin/with-conflicts.json',
      }).as;
