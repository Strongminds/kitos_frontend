...
describe('it-system-usage frontpage', () => {
  ...
  it('it-system usage frontpage', () => {
    testRunner.runTestWithSetup('can show IT system usage details', () => {
    ...
    testRunner.runTestWithSetup('redirects if missing read permission', () => {
    ...
    testRunner.runTestWithSetup('redirects if ressource is missing', () => {
    ...
    testRunner.runTestWithSetup('can remove IT system usage', () => {
      cy.contains('System 3').click();
    ...
    testRunner.runTestWithSetup('hides and disables input for IT system usage when user does not have rights', () => {
    ...
    testRunner.runTestWithSetup('can modify IT system usage', () => {
      cy.contains('System 3').click();
    ...
    testRunner.runTestWithSetup('does not override focused form fields', () => {
      cy.contains('System 3').click();
    ...
    testRunner.runTestWithSetup('shows error on invalid form', () => {
      cy.contains('System 3').click();
